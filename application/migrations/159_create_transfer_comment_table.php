<?php
class Migration_create_transfer_comment_table extends CI_Migration
{
    public function up()
    {
        $this->db->query("CREATE TABLE `transfer_comment` (
    ...
    { 
       $this->db->query("DROP TABLE transfer_comment");
    }
}
?>
