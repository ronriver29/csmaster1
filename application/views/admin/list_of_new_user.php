              ...
              <?php foreach ($users_list as $users) : ?>
                <tr>
                    ...
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        <a href="<?php echo base_url();?>admins/<?= encrypt_custom($this->encryption->encrypt($users['id'])) ?>/new_user_change_status" class="btn btn-color-blue btnNewUsers btn-sm ">Change Status</a>
