              ...
              <?php foreach ($users_list as $users) : ?>
                <tr>
                    ...
                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        ...
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteAdministratorModal" data-fname="<?= $users['first_name'].' '.$users['last_name'].' '.$users['middle_name']?>" data-email="<?=$users['email']?>" data-regno="<?= $users['regno'];?>" data-adid="<?= encrypt_custom($this->encryption->encrypt($users['id']))?>" data-status="<?= $users['status'];?>"><i class='fas fa-trash'></i> Delete</button>
                    </div>
                  </td>
                  <td>
                    <a href="<?php echo base_url();?>admins/<?= encrypt_custom($this->encryption->encrypt($users['id'])) ?>/new_user_change_status" class="btn btn-color-blue btnNewUsers btn-sm ">Cooperatives</a>
                    <a href="<?php echo base_url();?>admins/<?= encrypt_custom($this->encryption->encrypt($users['id'])) ?>/new_user_change_status_amendment" class="btn btn-color-blue btnNewUsersAmend btn-sm ">Amendment</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
