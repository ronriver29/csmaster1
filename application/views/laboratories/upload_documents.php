    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php if ($coop_info->category_of_cooperative === 'Primary'): ?>
                <?= base_url().'cooperatives/'.$cid.'/documents/bylaws_primary';?>
  ...
  <div class="col-sm-12 col-md-4">
    <div class="card">
      <div class="card-body">
        ...
        <a target="_blank" href="
        <?php if ($coop_info->category_of_cooperative === 'Primary'): ?>
                <?= base_url().'cooperatives/'.$cid.'/documents/articles_cooperation_primary';?>
        <?php elseif ($coop_info->grouping === 'Union'): ?>
  ...
  <div class="col-sm-12 col-md-4">
    <div class="card">
      <div class="card-body">
        ...
        <a target="_blank" href="
        <?php if ($coop_info->category_of_cooperative === 'Primary'): ?>
                <?= base_url().'cooperatives/'.$cid.'/documents/affidavit_primary';?>
        <?php elseif ($coop_info->grouping === 'Union'): ?>
  ...
  <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          ...
          <a target="_blank" href="<?php echo base_url();?>cooperatives/<?=$cid?>/documents/economic_survey" class="btn btn-primary">View</a>
        </div>
      </div>
  </div>
  <div class="col-sm-12 col-md-4">
