      ...
      <div class="card-body">
        <div class="row">
          ...
          <table class="table table-bordered" Width="100%">
            ...
            <tr>
              <td style="padding-left: 30px">a.2. The proposed location is outside 500-meter radius of the nearest cooperative engaged in the same line of business with that of the proposed branch (ocular inspection)</td>
              <?php if ($ans==null){
            ...
            <tr>
              <td style="padding-left: 30px">b.1. Members in the area to be served (list of members in the area)</td>
              <?php if ($ans==null){
            ...
            <tr>
              <td style="padding-left: 30px">b.3 The business responds to the needs of the members (interview, survey if applicable)</td>
              <?php if ($ans==null){
            ...
            <tr>
              <td style="padding-left: 30px">c.1. Availability of the required capital. (3 years AFS, operation and budget plan)</td>
              <?php if ($ans==null){
            ...
            <tr>
              <td style="padding-left: 30px">c.2. Presence of economic activity.( feasibility study)</td>
              <?php if ($ans==null){
