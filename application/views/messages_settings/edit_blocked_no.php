<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="modal fade" id="editBlockedNoModal" data-backdrop="static" data-hidden.bs.modal="this.form.reset();"tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?php echo form_open('api_settings/edit_blocked_no',array('id'=>'editAffiliatorForm','name'=>'editAffiliatorForm')); ?>
            ...
            <div class="modal-footer deleteCooperatorFooter">
              <input class="btn btn-color-blue btn-block" type="submit" id="deleteCooperatorBtn" name="deleteCooperatorBtn" value="Update">
            </div>
          </form>
        </div>
      </div>
