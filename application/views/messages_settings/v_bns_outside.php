...
<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <h5 class="text-primary text-right">SMS Allowed Actions - B&S Outside</h5>
  </div>
</div>
<style>
table {
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('api_settings/bns_outside',array('id'=>'editAdministratorForm','name'=>'editAdministratorForm')); ?>
      <div class="card-body">
        <table>
          <tr>
            <th>Action</th>
          ...
          <?php
            foreach($bns_outside_sms_list as $row){
              echo '<tr>';
