...
<?php }?>
<?php if(isset($list_cooperatives_inquiry)){?>
    <div class="col-sm-12 col-md-12">
     <div class="card border-top-blue shadow-sm mb-4">
      <div class="card-body">
        <?php
      if(count($list_cooperatives_inquiry) >= 1){
        foreach($list_cooperatives_inquiry as $row){
          echo '<center><h3><b>'.$row['payor'].'</b></h3></center><br/><hr/>';
          $obj = json_decode($row['epp_number'], true);
          // echo $obj['MERCHANTREFNO'];
          ...
          echo '<div class="row">';
            echo '<div class="col-md-2"></div>';
            echo '<div class="col-md-4"><b>Name of Applicant</b></div>';
            echo '<div class="col-md-4"><center>'.str_replace('Name of Applicant=','',$exp_particulars[4]).'</center></div>';
            echo '<div class="col-md-2"></div>';
          echo '</div>';

          echo '<div class="row">';
            echo '<div class="col-md-2"></div>';
            echo '<div class="col-md-4"><b>Proposed Name of Cooperative</b></div>';
            echo '<div class="col-md-4"><center>'.str_replace('Proposed Name of Cooperative=','',$exp_particulars[5]).'</center></div>';
            echo '<div class="col-md-2"></div>';
          echo '</div>';
          ...
          // echo '<br>'.print_r($list_cooperatives_inquiry);
