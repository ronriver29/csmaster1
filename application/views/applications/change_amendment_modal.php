    ...
    <div class="modal fade" id="changestatusModal" data-backdrop="static" data-hidden.bs.modal="this.form.reset();"tabindex="-1" role="dialog" aria-labelledby="assignSpecialistLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?php echo form_open('admins/change_status_amendment',array('id'=>'changestatusForm','name'=>'changestatusForm')); ?>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <input type="hidden" name="module_type" id="" value="Amendment">
                <div class="col-sm-12 col-md-12">
                    ...
                    <select class="custom-select validate[required]" name="statuschange" id="statuschange">
                      <option value="">--</option>
                       ...
                       <!--  else if($cooperative['status']==1) echo "PENDING";
                         ...
                         if($cooperative['status']==2)echo "FOR VALIDATION"; 
