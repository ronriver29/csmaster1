                ...
                <tr>
                  ...
                  <td>
                      ...
                      <span class="badge badge-secondary">
                        <?php if($branches['status']==80 )echo "FOR VALIDATION"; 
                        ?>
                  ...
                  <?php if(!$is_client) :?>
                    <td>
                      ...
                      <?php else: ?>
                        ...
                        <?php if($branches['status']==80): ?>
                          <?php 
                            $this->db->where(array('name'=>$branches['reg_type'],'active'=>1));
                            $this->db->from('head_office_coop_type_branch');
                            if($this->db->count_all_results()>0 && $admin_info->region_code != "00"){ ?>
                        ...
                        <?php if($branches['status']==3): ?>
                          ...
                          <?php } ?>
                          <?php endif; ?>
                        <?php if(($branches['status']>2 && $branches['status']<11 && $admin_info->access_level == 1) || ($branches['status']>3 && $branches['status']<11 && $admin_info->access_level == 2 || $admin_info->access_level == 3) && $branches['evaluated_by']!=0) : ?>
                        ...
                        <?php elseif($branches['status']==2 && $branches['evaluated_by']==0): ?>
                          <?php if($branches['grouping'] != 'Federation'){?>
                        ...
                        <?php elseif($branches['status']==14 || $branches['status']==15): ?>
