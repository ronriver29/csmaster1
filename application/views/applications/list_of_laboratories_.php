                ...
                <!-- <tr> modify by jayson -->
                  ...
                  <td>
                      ...
                      <?php if($is_client) : ?>
                        ...
                        <?php if($laboratory['status']==17) echo "DEFERRED"; ?>
                      ...
                      <?php else : ?>
                        <?php if($laboratory['status']==2 || $laboratory['status']==5) echo "FOR EVALUATION"; ?>

                      <!--   <?php if($laboratory['status']==8 || $laboratory['status']==9)echo "FOR EVALUATION"; ?> -->

                     <!--    <?php if($laboratory['status']==12 || $laboratory['status']==15) echo "FOR EVALUATION"; ?> -->

                         <?php if($laboratory['status']==12) echo "APPROVED BY SENIOR"; ?>
                        ...
                        <?php if($laboratory['status']==19) echo "WAITING FOR O.R."; ?>
                        <?php if($laboratory['status']==20) echo "FOR PRINTING"; ?>
                        <?php if($laboratory['status']==21) echo "REGISTERED"; ?>
                      <?php endif ?>
                  ...
                  <?php if(!$is_client) :?>
                    <td>
                      <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                       ...
                       <?php elseif($laboratory['status']==19): ?>
                          <input class="btn btn-color-blue offset-md-10" type="button" id="addOff" onclick="showPayment(<?=$laboratory['id']?>,'<?= encrypt_custom($this->encryption->encrypt($laboratory['coopName'].' - '.$laboratory['labName']))?>')" value="Save O.R. No.">
          ...
          <table class="table table-bordered" id="cooperativesTable2">
            ...
            <tbody>
              ...
              <?php foreach ($registered_laboratories as $laboratory1) : ?>
                ...
                <td>
                    <?php if($laboratory1['status']==21 || $laboratory1['status']==20): ?>
