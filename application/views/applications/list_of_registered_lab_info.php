                ...
                <tr>
                  ...
                  <td>
                      ...
                      <span class="badge badge-secondary">
                        <?php if($branches['status']==31)echo "UPDATED"; 
                        ?>
                  ...
                  <?php if(!$is_client) :?>
                    <?php if($branches['status']==31): ?>
                      <td>
                        ...
                        <!-- <div class="btn-group btn-group-sm" role="group" aria-label="Basic example"> -->
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editLabCertModal" data-fname="<?= $branches['first_name'].' '.$branches['last_name']?>" data-regno="<?= $branches['coop_id']?>" data-adid="<?= encrypt_custom($this->encryption->encrypt($branches['id']))?>" data-certno="<?=$branches['certNo']?>" data-regdate="<?=$branches['dateRegistered']?>" style="color:white;"><i class="fas fa-edit"></i> Edit</button>
                        <!-- </div> -->
                      </td>
                    <?php endif; ?>
                  <?php endif;?> 
