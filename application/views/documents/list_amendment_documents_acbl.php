    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <h5 class="card-title">By Laws</h5>
          ...
          {
          ?>
          <a target="_blank" href="<?php echo base_url();?>amendment_documents/list_upload_pdf/<?=$encrypted_id?>/40">
            <?php if($is_client) : ?>
            This is your Bylaws.
            <?php else : ?>
            Bylaws.
       ...
       <a target="_blank" href="
        ...
        " class="btn btn-primary">View</a> 
         <?php if($is_client && $coop_info->status<=1 || $coop_info->status==11){ ?>
                <a href="<?php echo base_url().'amendment/'.$encrypted_id.'/amendment_documents/upload_acbl/'.encrypt_custom($this->encryption->encrypt(40)).'/';?>" class="btn btn-primary">Upload</a>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          ...
          {
          ?>
          <a target="_blank" href="<?php echo base_url();?>amendment_documents/list_upload_pdf/<?=$encrypted_id?>/41">
            <?php if($is_client) : ?>
            This is your Article  of Cooperation.
            <?php else : ?>
          ...
          {
          ?>
          Please upload your Article  of Cooperation.
          <?php
          }
          ?>
        </p>
      ...
      <?php if ($coop_info->category_of_cooperative === 'Primary'): ?>
        ...
        <a target="_blank" href="<?=$url_?>" class="btn btn-primary" id="btn-article">View</a>
         <?php if($is_client && $coop_info->status<=1 || $coop_info->status==11){ ?>
                ...
                <a href="<?php echo base_url().'amendment/'.$encrypted_id.'/amendment_documents/upload_acbl/'.encrypt_custom($this->encryption->encrypt(41)).'/';?>" class="btn btn-primary">Upload</a>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      $('#btn-article').on('click',function(){
          ...
          alert("If total number of pages in Acknowledgement didn't appear, please refresh the pdf document page.");
