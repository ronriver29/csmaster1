...
<?php if($coop_info->status == 12){
    $bar = '<hr class="bar" />'; ?>
    <link rel="stylesheet" href="<?=base_url();?>assets/css/organizationalchart.css" media="all">
    <style>
      .bar {
  ...
  <ul class="tree"  style="">
    <li> <span>General</span>
      ...
      <ul>
        ...
        <li><?=$bar?><span style=""><u>Board of Director</u><br>
      ...
      <ul class="cheese" style="height:20px;">
          <div style="outline: none !important;margin-left:40%;width:50% !important;">
              <li style="width:40%;">
              </li>

              <li>
                <span class=""><u>Treasurer</u><br>
      ...
      ?>
    <ul class="tree" style=""><hr class="bar" style="width: <?=$width?>% !important;
        transform: rotate(90deg) !important;
        background: black;height:1px;<?=$margintop?>"/>
          <div style="outline: none !important;margin-left:40%;width:50% !important;">
              <li style="width:40%;">
              </li>
      ...
      <ul class="tree"  style="">
        <li>
          ...
          <ul>
                ...
                <li> <?=$bar?>
                  <span><u>Education Committee</u><br>
              <?php $count=1; foreach($education_committee as $educc){
               ...
               $count++; }?></span>
                ...
                <li> <?=$bar?>
                  <span><u>Med-Con Committee</u><br>
              <?php $count=1; foreach($medcon_committee as $mcc){
                echo $count.'. '.$mcc['full_name'].'<br>';
               $count++; }?></span>
                </li>
                <li><hr class="bar" style="width: 120% !important;
        transform: rotate(90deg) !important;
        background: black;height:1px;margin-top: 53% !important;margin-left: -9.5% !important;"/>
                  <span style="margin-top: 45% !important;"><u>Management Staff</u><br></span>
                </li>
                <li> <?=$bar?>
                  <span><u>Ethics Committee</u><br>
