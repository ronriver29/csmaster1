<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <?php if(($branch_info->status == 29 || $branch_info->status == 35 || $branch_info->status == 30) && !$is_client){ ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>for_closure" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } else if($branch_info->status != 21 && $branch_info->status <= 31) { ?>
    ...
    <?php else :?>
      ...
      <?php if($admin_info->access_level !=5 && $branch_info->status != 23 && $branch_info->status != 24 && $branch_info->status != 21 && $branch_info->status != 81) : ?>
        <div class="btn-group float-right" role="group" aria-label="Basic example">
          ...
          ?>
        <?php 
        if($branch_info->status != 18 && $branch_info->status != 23 && $branch_info->status != 33 && $branch_info->status != 38 && $branch_info->status != 37 && $branch_info->status != 39 && $branch_info->status != 29){
            if($admin_info->access_level == 3){
            ...
            <?php if($admin_info->access_level == 3 && $branch_info->status != 32 && ($is_active_director || $supervising_)) { ?>
...
<?php if(strlen((($branch_info->comment_by_senior_level1 || $branch_info->migrated == 1) && $admin_info->access_level==3)) && ($branch_info->status == 32 || $branch_info->status == 36)) : ?>
...
<?php endif;?>
<?php if(strlen(($branch_info->comment_by_specialist && $admin_info->access_level==2) || $admin_info->access_level==3) && ($branch_info->status != 23 || $branch_info->status == 36)) : ?>
...
<?php endif;?>
<?php if(strlen(($branches_comments_level1_defer && $admin_info->access_level==3) || ($branches_comments_level1_defer && $admin_info->access_level==2) || ($branches_comments_level1_defer && $branch_info->status == 35))) : ?>
...
<hr>
<?php
if($branch_info->status == 33 || $branch_info->status == 34 || $branch_info->status == 35 || $branch_info->status >= 36 ){ ?>
  <div class="row">
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
  ...
  <!--            Modify by anjury-->
          ...
          <?php if($is_client && $branch_info->status==33): ?>
