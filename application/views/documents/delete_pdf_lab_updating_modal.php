<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="modal fade" id="deleteLabPDFModal" data-backdrop="static" data-hidden.bs.modal="this.form.reset(); "tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?php echo form_open('documents/delete_pdf_lab_updating',array('id'=>'deleteDocumentForm','name'=>'deleteDocumentForm')); ?>
            ...
            <div class="modal-body">
              ...
              <div class="alert alert-warning" role="alert">
                ...
                <p><strong class="pdf-name-text">test</strong> will be remove in <strong class="pdf-cname-text">test</strong> uploaded documents. There is no way to recover this.</p>
              </div>
            </div>
