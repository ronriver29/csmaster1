<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <?php if($is_client){ ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_branch_id ?>/bns_conversion" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } else if($branch_info->status != 21 && $is_client && $branch_info->status != 81 || (!$is_client && ($branch_info->status >= 55))){ ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>for_conversion" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } else {?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_branch_id ?>/bns_conversion" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php }?>
    ...
    <hr>
    <?php else :?>
      <?php if($branch_info->status == 23 || $branch_info->status == 24 || $branch_info->status == 42){ ?>
      ...
      <?php if($admin_info->access_level !=5 && $branch_info->status != 23 && $branch_info->status != 24 && $branch_info->status != 21 && $branch_info->status != 81) : ?>
        ...
        if($branch_info->status != 18 && $branch_info->status != 23 && $branch_info->status != 42 && $branch_info->status != 63){
            ...
            if($branch_info->migrated == 1){
              ...
              $branchname = $branch_name.' '.$branch_info->branchName;
            }
            ?>
...
<?= $branch_info->tool_findings?>" data-cname="<?= $branchname?>" data-coopid="<?= encrypt_custom($this->encryption->encrypt($branch_info->id))?>">Defer</button>
            <?php } ?>
        <?php  } ?>
...
<?php if(strlen((($branch_info->comment_by_senior_level1 || $branch_info->migrated == 1) && $admin_info->access_level==3)) && $branch_info->status == 56 || $branch_info->status == 61) : ?>
...
<?php endif;?>
<?php if(strlen((($branch_info->comment_by_specialist || $branch_info->migrated == 1) && $admin_info->access_level==2) || $admin_info->access_level==3) && $branch_info->status == 60 || $branch_info->status == 61) : ?>
        ...
        <p class="text-muted">
          ...
          <?php
            if($branch_info->migrated == 1){
              ...
              echo $branch_name.' '.$branch_info->branchName;
            }
          ?>
        </p>
        ...
        <div class="card">
          <div class="card-body">
              ...
              <p class="card-text">
                ...
                <?php if(isset($document_letter_of_intent)) : ?>
                 <!--  <a target="_blank" href="<?php echo base_url();?>cooperatives/<?=$encrypted_id?>/documents/view_document_one/<?= encrypt_custom($this->encryption->encrypt($document_one->filename))?>"> -->
                   ...
                   <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_id_others?>/43">
            ...
            <?php if($is_client && ($branch_info->status==21 || $branch_info->status==81)): ?>
              <?php if($is_client) : ?>
                  <a href="<?php echo base_url();?>branches/<?=$encrypted_id_others?>/documents_conversion/upload_document_letter_of_intent" class="btn btn-primary">Upload</a>
              <?php endif;?>
            <?php endif; ?>
...
if($branch_info->status == 57 || (($branch_info->status >= 59) && !$is_client) || $branch_info->status >= 63){
  ...
  <div class="row">
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Copy of the Notice of Conversion</h5>
          <p class="card-text">
            <?php if($document_50) : ?>
  <!--            Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_5/<?= encrypt_custom($this->encryption->encrypt($document_5->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/50">
                This is the uploaded copy of the Notice of Conversion.
              </a>
            <?php endif ?>
            <?php if(!$document_50) : ?>
              Please upload your copy of the Notice of Conversion.
            <?php endif ?>
            <br>
          </p>
          <?php if($is_client && $branch_info->status==57 || $branch_info->status==64): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_conversion_submission/upload_document_for_conversion_50" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <?php if($document_51) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_6/<?= encrypt_custom($this->encryption->encrypt($document_6->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/51">
          ...
          <?php if($is_client && $branch_info->status==57 || $branch_info->status==64): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_conversion_submission/upload_document_for_conversion_51" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <?php if($document_52) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/52">
          ...
          <?php if($is_client && $branch_info->status==57 || $branch_info->status==64): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_conversion_submission/upload_document_for_conversion_52" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
  ...
  <!-- <div class="row">
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Oath of Undertaking, signed by the Chairperson of the cooperative, citing the specific services/activities to be undertaken by the proposed satellite office</h5>
          <p class="card-text">
            <?php if($document_53) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/53">
              This is the uploaded Certificate/Letter of Authority.
              </a>
            <?php endif ?>
            <?php if(!$document_53) : ?>
          ...
          <?php if($is_client && $branch_info->status==57): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_conversion_submission/upload_document_for_conversion_53" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
...
<?php } else {  ?>
      ...
      <div class="col-sm-12 col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">
              <?php if($document_5) : ?>
                <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/5">
                  This is the uploaded Business Plan.
                </a>
              <?php endif ?>
              <?php if(!$document_5) : ?>
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <?php if($document_6) : ?>
                <!--Modify by anjury-->
                <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_6/<?= encrypt_custom($this->encryption->encrypt($document_6->filename))?>">-->
                <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/6">
                  This is the uploaded G.A. Resolution.
                </a>
              <?php endif ?>
              <?php if(!$document_6) : ?>
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <?php if($document_7) : ?>
                <!--Modify by anjury-->
                <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
                <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/7">
                This is the uploaded Certification.
                </a>
              <?php endif ?>
              <?php if(!$document_7) : ?>
  ...
  <!--            Modify by anjury-->
    ...
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Certification by the General Manager/Chairman that the notice was posted;</h5>
          <p class="card-text">
            <?php if($document_51) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_6/<?= encrypt_custom($this->encryption->encrypt($document_6->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/51">
                This is the uploaded Certificate.
              </a>
            <?php endif ?>
            <?php if(!$document_52) : ?>
    ...
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">The original Letter of Authority</h5>
          <p class="card-text">
            <?php if($document_52) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/52">
              This is the uploaded Certificate/Letter of Authority.
              </a>
            <?php endif ?>
            <?php if(!$document_53) : ?>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Certification signed by the Chairman/General Manager of the that the branch has a Manual of Operations</h5>
          <p class="card-text">
            <?php if($document_53) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/53">
              This is the uploaded Certificate/Letter of Authority.
              </a>
            <?php endif ?>
            <?php if(!$document_53) : ?>
    ...
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Audited Financial Statements for the last 3 years</h5>
          <p class="card-text">
            <?php if($document_54) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_conversion/list_upload_pdf_branch/<?=$encrypted_branch_id?>/54">
              This is the uploaded Certificate/Letter of Authority.
              </a>
            <?php endif ?>
            <?php if(!$document_54) : ?>
          ...
          <?php if($is_client && $branch_info->status==57 || $branch_info->status==64): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_conversion_submission/upload_document_for_conversion_54" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
