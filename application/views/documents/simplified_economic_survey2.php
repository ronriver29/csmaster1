            ...
            <tbody>
              <tr><!--foreach-->
                <td>
                  ...
                  {
                    echo"Working and/or residing in the area of operation.";
                  }
        ...
        <li><?=$bar?> <span><u>Election Committee</u><br>
          <?php $count=1; foreach($election_committee as $ec){
           ...
           $count++; }?></span>
                ...
                <span style="margin-left:60% !important;"><u>Treasurer</u><br>
                <?php $count=1; foreach($treasurer_committee as $tc){
                echo $count.'. '.$tc['full_name'].'<br>';
                $count++; }?></span>
              
      
                <span style="margin-left:60% !important;"><u>Secretary</u><br>
        ...
        <li> 
          ...
          <ul>
              ...
              <?php $count=1; foreach($ethics_committee as $ec){
               ...
               $count++; }?></span>
                ...
                <li> <hr class="barMS" style="margin-bottom: 8% !important;"/>
                  <span><u>Management Staff</u><br></span>
                </li>
                <li> <?=$bar?>
              ...
              <?php $count=1; foreach($other_committee as $otherc){
                echo $count.'. '.$otherc['full_name'].'<br>';
               $count++; }?></span>
                </li>
