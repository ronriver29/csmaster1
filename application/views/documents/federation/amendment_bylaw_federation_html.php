...
<div class="container-fluid text-monospace" id="printPage" style=" border:1px solid black;padding:50px;">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify font-weight-regular">Section 1. <i class="font-weight-bold">Membership.</i> This Federation of Cooperatives shall have <?php  echo ($bylaw_info->kinds_of_members == 1)? "regular members only" : "regulars and associate members";?>.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 2. <i class="font-weight-bold">Qualification for Membership.</i> - The membership of this Federation of Cooperatives is open to any registered primary cooperative within the common bond of membership.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
     	...
     	<ol class="text-justify" type="a">
        	...
        	<li>Pay the installment of its share capital subscription as it falls due and participate in the capital build-up and savings mobilization activities of the federation;</li>
			...
			<li>Remit the Cooperative Education and Training Fund (CETF) due to the Federation in accordance with the Memorandum of Agreement entered into with the Federation of Cooperatives; and</li>
      ...
      <ul class="text-justify">
        ...
        <li>Associate Members
          ...
          <ol class="text-justify" type="a">
            ...
            <li>Inspect and examine the books of accounts, the audited financial statements, the minute's books, the share register, and other records of the Federation during reasonable office hours;</li>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
        ...
        <li>Has paid the membership fee and the value of the minimum shares  required for membership;</li>
  			...
  			<li>Has remitted the Cooperative Education and Training Fund (CETF) due to the Federation; and</li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 10. <i class="font-weight-bold">Liability of Members.</i> A member shall be liable for the debts of the Federation only to the extent of its subscribed share capital.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 11. <i class="font-weight-bold">Termination of Membership.</i> Termination of membership may  be automatic, voluntary or involuntary, which shall have the effect of  extinguishing all rights of a member in the Federation, subject to the refund of share capital contribution under Section 14 hereof.</p>
        ...
        <li><strong>Automatic Termination of Membership.</strong> The dissolution or the insolvency of a member shall be considered an automatic termination of its membership in the Federation.</li>
				...
				<li><strong>Involuntary Termination.</strong> A member may be terminated by a vote of the majority of all the members of the Board of Directors for any of the following causes:
						...
						<ol class="text-justify" type="1" id="customlist">
  						...
  						<li>Has violated any provision of these By-laws and the policies promulgated by the board of directors of the Federation; and</li>
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 13. <i class="font-weight-bold">Refund of Share Capital Contribution.</i> A member whose membership is terminated shall be entitled to a refund of its share capital contribution and all other interests in the Federation. However, such  refund shall not be made if upon payment the value of the assets of the Federation would be less than the aggregate amount of its debts and liabilities exclusive of its share capital contribution. In which case, the terminated member shall continue to be entitled to the interest of its share capital contributions, patronage refund and the use of the services of the  Federation until such time that all its interests in the Federation shall have been duly paid.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
        ...
        <li>The Tertiary or Union to which the Federation is a member or  </li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
        ...
        <li>Presentation and approval of the reports of the board of directors, officers, and the committees, including audited financial statements of the Federation; </li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
    		...
    		<li>Establish policies and procedures for the effective operation of the Federation and ensure its proper implementation; </li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify" style="text-indent: 50px;">In cases where the officers sought to be removed consist of the majority of the Board of Directors, at least 10% of the member with voting rights may file a petition with the CDA, upon failure of the Board of Directors to call an assembly meeting for the purpose to commence the proceeding for their removal within thirty (30) days from notice. The decision of the General Assembly on the matter is final and executory.</p>
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 1. <i class="font-weight-bold">Audit Committee.</i> An Audit Committee is hereby created and shall be composed of three (3) members to be elected during a general assembly meeting and shall hold office for a term of one (1) year or until their successors shall have been elected and qualified. Within ten (10) days after their election, they shall elect from among themselves a Chairperson, Vice-Chairperson, and a Secretary. No member of the committee shall hold any other position within the Federation during his term of office. The Committee shall provide internal audit service, maintain a complete record of its examination and inventory, and submit an audit report quarterly or as may be required by the Board and the General Assembly.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
      	...
      	<li>Keep members, officers, staff well-informed regarding the Federation’s goals/objectives, policies & procedures, services, etc.;</li>

    		<li>Plan and implement educational program for coop members, officers and staff;</li>

    		<li>Develop promotional and training materials for the Federation;</li>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
      	...
      	<li>Formulate and develop the Conciliation-Mediation Program and ensure that it is properly implemented;</li>
    		...
    		<li>Issue the Certificate of Non-Settlement after exhaustion of reasonable efforts to settle the disputes lodged;</li>
 ...
 <!--  <div class="row">
        ...
        <li><i class="font-weight-bold">Chairperson</i> – The Chairperson shall:
      	...
      	<li><i class="font-weight-bold">Treasurer</i> – The Treasurer shall:
      		...
      		<ol type="i">
      			...
      			<li>Monitor and review the financial management operations of the Federation, subject to such limitations and control as may be prescribed by Board of Directors;</li>
      	...
      	<li><i class="font-weight-bold">Secretary</i> – The Secretary shall:
      	 ...
      	 <li><i class="font-weight-bold">General Manager</i>. The General Manager shall:
      		...
      		<ol type="i">
      			...
      			<li>Formulate and recommend in coordination with the operating departments under his/her supervision, the Federation’s Annual and Medium Term Development Plan, programs, and projects, for approval of the Board of Directors, and ratification of General Assembly; </li>

      			<li>Implement the duly approved plans and programs of the Federation and any other directive or instruction of the Board of Directors; </li>

      			<li>Provide and submit to the Board of Directors monthly reports on the status of the federation’s operation vis-a-vis its target and recommend appropriate policy or operational changes, if necessary;</li>

      			<li>Represent the federation in any agreement, contract, business dealings, and in any other official business transaction as may be authorized by the Board of Directors;</li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 2. <i class="font-weight-bold">Liabilities of Directors, Officers and Committee Members.</i> Directors, officers and committee members, who willfully and knowingly vote for or assent to patently unlawful acts, or who are guilty of gross negligence or bad faith in directing the affairs of the Federation or acquire any personal or pecuniary interest in conflict with their duties as Directors, officers or committee members shall be liable jointly and severally for all damages resulting therefrom to the federation, members and other persons. When a director, officer or committee member attempts to acquire, or acquires in violation of his duties, any interest or equity adverse to the Federation in respect to any matter which has been reposed in him in confidence, he shall, as a trustee for the Federation, be liable for damages or loss of profits which otherwise would have accrued to the Federation.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="font-weight-regular text-justify">Section 6. <i class="font-weight-bold">Duties of the Accountant.</i> The Accountant of the Federation, who is under the supervision and control of the General Manager shall:</p>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
      	...
      	<li>Install an adequate and effective accounting system within the Cooperative; </li>
  			...
  			<li>Render reports on the financial condition and operations of the Federation whether monthly, annually or as may be required by the Board of Directors and/or the General Assembly;</li>

  			<li>Assist the Board of Directors in the preparation of the annual budget;</li>

  			<li>Keep, maintain and preserve all books of accounts, documents, vouchers, contracts and other records concerning the business of the Federation and make them available for auditing purposes to the Chairperson of the Audit Committee; and</li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="font-weight-regular text-justify">Section 7. <i class="font-weight-bold">Duties of the Bookkeeper.</i> The bookkeeper of the Federation, who is under the supervision and control of the Accountant shall:</p>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
      	...
      	<li>Records and update books of accounts; </li>
  			...
  			<li>Assist in the preparation of reports on the financial condition and operations of the Federation whether monthly, annually or as may be required by the Board of Directors and/or the general assembly;</li>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
        ...
        <li>At least <?=ucwords(num_format_custom($bylaw_info->member_invest_per_month))?> Pesos (P<?=$bylaw_info->member_invest_per_month?>)per annum; </li>
    		...
    		<li>At least <?=ucwords(num_format_custom($bylaw_info->member_percentage_service))?> percent (<?=$bylaw_info->member_percentage_service?>%) of each goods procured /services acquired from the Federation. </li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 7. <i class="font-weight-bold">Fines on Unpaid Subscribed Share Capital.</i> The Board of Directors shall prescribe a reasonable fine for the unpaid subscription of share capital.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 8. <i class="font-weight-bold">Share Capital Certificate.</i> The Board of directors shall issue a Share Capital Certificate only to an member who has fully paid his subscription. </p>

        <p class="text-justify font-weight-regular" style="text-indent: 50px;"> The Certificate shall be serially numbered and contain the share holder’s name, the number of shares owned, the par value, and duly signed by the Chairperson and the Secretary, and bearing the official seal of the Federation. All certificates issued and/or transferred shall be registered in the Federation’s Share and Transfer Book.</p>
        ...
        <p class="text-justify font-weight-regular" style="text-indent: 50px;">The shares may be purchased, owned or held only by the primary cooperative who are eligible for membership. Subject to existing government rules or laws, interests shall be paid only to paid-up shares which may be in cash; or credited as payment of unpaid subscriptions, outstanding accounts, or additional shares or to the revolving fund of the Federation. </p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify font-weight-regular">Section 9. <i class="font-weight-bold">Transfer of Shares.</i>The Federation shall have the first option to buy any share offered for sale. The amount to be paid for such shares shall be the par value provided that:</p>
 ...
 <div class="row mb-4">
      ...
      <ol class="text-justify" type="a">
        ...
        <li> <i class="font-weight-bold">Reserve Fund.</i> <?= ucwords(num_format_custom($bylaw_info->percent_reserve_fund))?> percent (<?=$bylaw_info->percent_reserve_fund?>%) shall be set aside for Reserve Fund subject to the following rules, provided, that in the first five (5) years of operation after registration, this amount shall not be less than fifty per centum (50%) of the net surplus:
        		...
        		<li>The reserve fund shall be used for the stability of the Federation and to meet net losses in its operations. The general assembly may decrease the amount allocated to the reserve fund when it has already exceeded the authorized share capital. Any sum recovered on items previously charged to the reserve fund shall be credited to such fund.</li>
        			...
        			<ol type="a">
  							...
  							<li>To establish a usufructuary fund for the benefit of any Tertiary Cooperative of Federations or Union to which the Federation is a member; or</li>

  							<li>To donate, contribute or otherwise dispose of the amount for the benefit of the community where the Federation operates. If the members could not decide on the disposition of the reserve fund, the same shall be given to the Federations or union to which the Federation is a member.</li>
        ...
        <li><i class="font-weight-bold">Education and Training Fund.</i> <?= ucwords(num_format_custom($bylaw_info->percent_education_fund))?> percent (<?=$bylaw_info->percent_education_fund?>%) shall be set aside for Education and Training Fund.
          	...
          	<ol type="i">
  				...
  				<li>Half of the amount allocated to the education and training fund annually under this subsection may be spent by the Federation for education and training purposes; while the other half may be remitted to a union or tertiary cooperative federation chosen by the Federation of which it is a member.</li>

  				<li>Upon the dissolution of the Federation, the unexpended balance of the education and training fund pertaining to the Federation shall be credited to the education and training fund of the chosen union or tertiary cooperatives.</li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="font-weight-regular text-justify">Section 2. <i class="font-weight-bold">Interest in Share Capital and Patronage Refund.</i> The remaining net surplus shall be made available to the members in the form of interest on share capital not to exceed the normal rate of return on investment and patronage refunds. Provided, that any amount remaining after the allowable interest and the patronage refund have been deducted shall be credited to the reserved to the reserved fund. The sum allocated for patronage refund shall be made available at the same rate to all patrons of the Federation in proportion to their patronage, provided that:</p>
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
      	...
      	<li>In the case of a patron cooperative member with paid-up share capital contribution, the proportionate amount of patronage refund shall be paid to such cooperative unless it agrees to credit the amount to its account as additional share capital contribution;</li>
    		...
    		<li>In the case of non-member patron cooperative, its proportionate amount of patronage refunds shall be set aside in a general fund and shall be allocated to such non-member patron cooperative and only upon request and presentation of evidence of the amount of its patronage. The amount so allocated shall be credited to such patron toward the payment of the minimum capital contribution for membership. When a sum equal to this amount has accumulated at any time within <?= num_format_custom($bylaw_info->non_member_patron_years)?> (<?=$bylaw_info->non_member_patron_years ?>) years, such patron shall be deemed and become a member of the Federation if the former so agrees or requests and complies with the provisions of the By-laws for admission to membership; and</li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
    		...
    		<li>Any reputable bank in the locality or any tertiary copoeratives of which it is a member and cooperative banks; </li>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify" style="text-indent: 50px;">The Federation shall submit the web-based Cooperative Annual Progress Report (CAPR) together with the following attachments to the Authority within (120) days from the end of every calendar year:</p>
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
    		...
    		<li>List of cooperatives that have remitted their respective Cooperative Education and Training Funds (CETF);</li>

    		<li>Business consultancy assistance to include the nature and cost and</li>

    		<li>Other training activities undertaken to specify therein the nature, participants, and cost of the activity. </li>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered table-sm table-cooperator">
          ...
          <tbody>
            ...
            <?php $count=1; foreach($cooperators_list as $cooperator) :?>
              <tr>
