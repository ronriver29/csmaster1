...
<div class="container-fluid text-monospace" id="printPage" style=" border:1px solid black;padding:50px;">
  ...
  <div class="row mb-2 ">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify font-weight-normal" style="text-indent: 50px;">We, the undersigned duly authorized representative(s) of our respective cooperatives, all of legal age and Filipino citizens, have on this day voluntarily agreed to organize a Federation of Cooperatives, under the laws of the Republic of the Philippines, hereinafter referred to as the Federation.</p>
  ...
  <div class="row ">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <p class="text-justify" style="text-indent: 50px;">That the purpose(s) for which this Federation is organized is/are to engage in:</p>
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12">
        ...
        <ol class="text-justify" type="1">
          ...
          <?php $content_array = explode(';',$purpose['content']); 
            foreach ($content_array as $key => $content) {
              echo'<li>'.$content.'</li>';
            }
            unset($content);
          ?>
           <!--  <li><?=$purpose['content']?></li> -->
          <?php endforeach; unset($purpose);?>
  ...
  <div class="row ">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify" style="text-indent: 50px;">That the powers, rights and capacities of this Federation are those prescribed under Article 9 of Republic Act 9520. as follows</p>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered table-sm">
          ...
          <tbody>
            ...
            <?php $count=1; foreach($members_list as $members) :?>
  ...
  <div class="row ">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify" style="text-indent: 50px;">That the number of Directors of this Federation shall be <?=num_format_custom($no_of_directors)?>(<?= $no_of_directors?>) and the names of the Board of  Directors are as follows: </p>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            ...
            <?php $count=1; foreach($directors_list as $director) :?>
            <tr>
  ...
  <div class="row ">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify" style="text-indent: 50px;">That this  Federation is composed of duly registered cooperatives engaged in <?=$coop_info->type_of_cooperative?>, willing to patronize the services of this Federation, and possess all the qualifications  and none of the disqualifications provided for in the Bylaws.</p>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            ...
            <?php $count=1; foreach($members_list as $regular) : ?>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            ...
            <?php $count=1; foreach($associate_cooperator_list as $associate) : ?>
            <tr>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            ...
            <?php  $count=1;foreach($members_list as $cooperator) :?>
