...
<div class="container-fluid text-monospace" id="printPage" style=" border:1px solid black;padding:50px;">
  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify" style="text-indent: 50px;"> <b><?=(isset($treasurer_of_coop->representative)? $treasurer_of_coop->representative : '___________')?></b> has been elected as Treasurer of this Tertiary Cooperative to act as such until her/his successor shall have been duly appointed and qualified in accordance with the By-laws. As such Treasurer, he/she is authorized to receive payments and issue receipts for membership fees, share capital subscriptions and other revenues, and pay obligations for and in the name of this Tertiary Cooperative.</p>
