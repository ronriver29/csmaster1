  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li> <?= ucwords(num_format_custom($capitalization_info->preferred_share))?> (<?= number_format($capitalization_info->preferred_share,2)?>) preferred shares with a par value of <?= ucwords(num_format_custom($capitalization_info->par_value))?> (<?=$capitalization_info->par_value?> ) per share.</li>
        <?php endif;?>
      </ol>
    </div>
  </div>
