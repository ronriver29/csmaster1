...
<html lang="en">
  ...
  body{font-family: 12 Bookman Old Style !important;}
  </style>
</head>
...
<div class="container-fluid text-monospace">
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">BY-LAWS<br>OF<br><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative <?= $coop_info->grouping?></p>
    </div>
  </div>
  <div class="row mb-2">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">We, the undersigned Filipino citizens, of legal age, and residents of the Philippines, representing at least majority of the members of this <b><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative <?= $coop_info->grouping?></b>, do hereby adopt this By-laws.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify font-weight-regular">Section 6. <i class="font-weight-bold">Minimum Share Capital Requirement.</i> An applicant for <strong>regular membership</strong> shall subscribe at least <b><?= num_format_custom($capitalization_info->minimum_subscribed_share_regular)?></b> (<b><?= $capitalization_info->minimum_subscribed_share_regular?></b>) shares and pay the value of at least <b><?= num_format_custom($capitalization_info->minimum_paid_up_share_regular)?></b> (<b><?= $capitalization_info->minimum_paid_up_share_regular?></b>) shares upon approval of his/her membership.</p>
      <?php if($bylaw_info->kinds_of_members == 2) :?>
      <p class="text-justify">An applicant for <strong>associate membership</strong> shall subscribe at least <b><?= num_format_custom($capitalization_info->minimum_subscribed_share_associate)?></b> (<b><?= $capitalization_info->minimum_subscribed_share_associate?></b>) shares and pay the value of at least <b><?= num_format_custom($capitalization_info->minimum_paid_up_share_associate)?></b> (<b><?= $capitalization_info->minimum_paid_up_share_associate?></b>) shares upon approval of his/her membership.</p>
      <?php endif;?>
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify mb-4" style="text-indent: 50px;">We, constituting the majority of the Board of Directors of the <b><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative <?= $coop_info->grouping?></b> do hereby certify that the foregoing instrument is the Code of By-laws of this Cooperative.</p>
