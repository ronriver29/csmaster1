...
<div class="container-fluid text-monospace">
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12 text-center">
        ...
        // var_dump($proposedName); var_dump($proposedName_previousinal);

        // echo strcasecmp($proposedName,$proposedName_previousinal);

          if($proposedName !== $proposedName_previousinal)
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <p class="text-justify" style="text-indent: 50px;">We, the undersigned Filipino citizens, of legal age, and residents of the Philippines, representing at least majority of the members of this <?=$proposedName?>, do hereby adopt this By-laws.</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <?php
        ...
        if($bylaw_info_previous->kinds_of_members!= $bylaw_info->kinds_of_members)

        {

          $bylaws_kind_of_members ='<strong>'.($bylaw_info->kinds_of_members == 1? "regular members only" : "regular and associate members".'</strong>');
          ...
          <ol class="text-justify" type="a">
            ...
            <?php
             ...
             foreach($regular_ar_qualifications as $key => $reg_qualification) :
              ...
              if(isset($regular_ar_qualifications_previous[$key]))

              {

                $reg_qualification_previous = $regular_ar_qualifications_previous[$key];

                if($reg_qualification!=$reg_qualification_previous)
        ...
        <li>Associate Members
          ...
          <ol class="text-justify" type="a">
            ...
            <?php foreach($assoc_ar_qualifications as $key => $assoc_qualification) :
              ...
              if(isset($assoc_ar_qualifications_previous[$key]))

              {

                $assoc_qualification_previous=$assoc_ar_qualifications_previous[$key];

                 if($assoc_qualification_previous!=$assoc_qualification)
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="1">
        ...
        <?php if(strlen($bylaw_info->additional_requirements_for_membership)>0) :?>
          ...
          <?php foreach($members_additional_requirements as $key=> $requirement) : 

            if(empty($members_additional_requirements_previous[$key]))

            {

              $members_additional_requirements_previous[$key]=0;

            }

            $requirement_previous = $members_additional_requirements_previous[$key];

            if($requirement_previous!==$requirement)

            {

              $requirement = '<strong>'.$requirement.'</strong>';
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <?php
       ...
       if($bylaw_info_previous->act_upon_membership_days!=$bylaw_info->act_upon_membership_days)

       {

          $bylaw_info->act_upon_membership_days = '<strong>'.$bylaw_info->act_upon_membership_days.'</strong>';
      ...
      $membership_feeSS = number_format($bylaw_info->membership_fee,2);

      $membership_fee2 = ucwords(num_format_custom($bylaw_info->membership_fee));



       if($bylaw_info_previous->membership_fee!=$bylaw_info->membership_fee)

       {

        $membership_feeSS = '<strong>'.  $membership_feeSS.'</strong>';

        $membership_fee2 = '<strong>'.$membership_fee2.'</strong>';
  ...
  <?php
    ...
    if($capitalization_info_previous->minimum_subscribed_share_regular!=$capitalization_info->minimum_subscribed_share_regular)
    ...
    if($capitalization_info_previous->minimum_paid_up_share_regular!=$capitalization_info->minimum_paid_up_share_regular)

    {

      $minimum_paid_up_share_regular='<b>'.num_format_custom($capitalization_info->minimum_paid_up_share_regular).'</b>';

       $minimum_paid_up_share_regular2='<strong>'.num_format_custom($capitalization_info->minimum_paid_up_share_regular).'</strong>';
...

    {
      ...
      $minimum_paid_up_share_regular=$capitalization_info->minimum_paid_up_share_regular;
       ...
       $minimum_paid_up_share_regular2=num_format_custom($capitalization_info->minimum_paid_up_share_regular);

    }

    if($capitalization_info_previous->minimum_subscribed_share_associate!=$capitalization_info->minimum_subscribed_share_associate)
...
$minimum_paid_up_share_associate_3 ='';
    ...
    if($capitalization_info_previous->minimum_paid_up_share_associate!=$capitalization_info->minimum_paid_up_share_associate)
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="1">
        ...
        <?php if(strlen($bylaw_info->additional_conditions_to_vote)>0) :?>
          ...
          <?php foreach ($members_additional_conditions_to_vote as $key=> $condition) :

            if(empty($members_additional_conditions_to_vote_previous[$key]))

            {

              $members_additional_conditions_to_vote_previous[$key]=null;

            }

            $condition_previous = $members_additional_conditions_to_vote_previous[$key];
  ...
  <div class="row">
    ...
    if($bylaw_info_previous->annual_regular_meeting_day!=$bylaw_info->annual_regular_meeting_day)

    {

      $bylaw_info->annual_regular_meeting_day='<strong>'.$bylaw_info->annual_regular_meeting_day.'</strong>';
  ...
  <div class="row">
    ...
    if($bylaw_info_previous->members_percent_quorom!=$bylaw_info->members_percent_quorom)

    {

      $quorum_word ='<b>'.$quorum_word.'</b>';
  ...
  <div class="row">
    ...
    if($bylaw_info_previous->number_of_absences_disqualification !=$bylaw_info->number_of_absences_disqualification)

    {

      $number_of_absences_disqualification='<strong>'.$bylaw_info->number_of_absences_disqualification.'</strong>';

      $number_of_absences_disqualification2='<strong>'.num_format_custom($bylaw_info->number_of_absences_disqualification).'</strong>';
...

    {
      ...
      $number_of_absences_disqualification2=num_format_custom($bylaw_info->number_of_absences_disqualification);

    }

    if($bylaw_info_previous->percent_of_absences_all_meettings!=$bylaw_info->percent_of_absences_all_meettings)

    {

      $absence_meeting='<strong>'.ucwords(num_format_custom($bylaw_info->percent_of_absences_all_meettings)).'</strong>';

      $bylaw_info->percent_of_absences_all_meettings2='<strong>'.$bylaw_info->percent_of_absences_all_meettings.'%</strong>';
...

    {
     ...
     $absence_meeting=ucwords(num_format_custom($bylaw_info->percent_of_absences_all_meettings));

       $bylaw_info->percent_of_absences_all_meettings2 = $bylaw_info->percent_of_absences_all_meettings;
      ...
      <ol class="text-justify" type="a">
        ...
        <li>Holding any elective position in the government, except that of a party list representative being an officer of a Cooperative he/she represents; </li>
    		...
    		<li>Having direct or indirect personal interest with the business of the Cooperative; </li>
      		...
      		<li>Having been absent for <?= $number_of_absences_disqualification2 ?>(<?= $number_of_absences_disqualification ?>) consecutive meetings or in more than <?=$absence_meeting ?> percent (<?= $bylaw_info->percent_of_absences_all_meettings2?>) of all meetings within the twelve (12) month period unless with valid excuse as approved by the Board of Directors;</li>
  ...
  <div class="row">
    ...
    $director_hold_term2=num_format_custom($bylaw_info->director_hold_term);

    $director_hold_term=$bylaw_info->director_hold_term;

    if($bylaw_info_previous->director_hold_term!=$bylaw_info->director_hold_term)

    {

      $director_hold_term='<strong>'.$director_hold_term.'</strong>';

      $director_hold_term2='<strong>'.$director_hold_term2.'</strong>';
...
<?php } //end if credit */?>
  ...
  <div class="row">
    ...
    if($bylaw_info_previous->member_invest_per_month!=$bylaw_info->member_invest_per_month)
    ...
    if($bylaw_info_previous->member_percentage_annual_interest!=$bylaw_info->member_percentage_annual_interest)

    {

      $member_percentage_annual_interest ='<strong>'.$bylaw_info->member_percentage_annual_interest.'%</strong>';

      $member_percentage_annual_interest2 ='<strong>'.num_format_custom($bylaw_info->member_percentage_annual_interest).' percent</strong>';
...

    {
      ...
      $member_percentage_annual_interest2 =num_format_custom($bylaw_info->member_percentage_annual_interest).' percent';
    ...
    if($bylaw_info_previous->member_percentage_service!=$bylaw_info->member_percentage_service)
 ...
 <?php 
  ...
  <div class="row">
    ...
    if($bylaw_info_previous->percent_reserve_fund!=$bylaw_info->percent_reserve_fund)

    {

      $percent_reserve_fund='<strong>'.num_format_custom($bylaw_info->percent_reserve_fund).' percent</strong>';

       $bylaw_info->percent_reserve_fund2='<strong>'.$bylaw_info->percent_reserve_fund.'%</strong>';
    ...
    if($bylaw_info->percent_education_fund!=$bylaw_info_previous->percent_education_fund)

    {

      // $bylaw_info->percent_education_fund ='<strong>'.$bylaw_info->percent_education_fund.'</strong>';

      $bylaw_info->percent_education_fund2 = '<strong>'.$bylaw_info->percent_education_fund.'%</strong>';
...

    {
      ...
      $bylaw_info->percent_education_fund2 = $bylaw_info->percent_education_fund.'%';

    }



    if($bylaw_info_previous->percent_community_fund!=$bylaw_info->percent_community_fund)

    {

      $percent_community_funds='<strong>'. num_format_custom($bylaw_info->percent_community_fund).' percent</strong>';

     $percent_community_funds2='<strong>'. $bylaw_info->percent_community_fund.'%</strong>';
...

    {
       ...
       $percent_community_funds=num_format_custom($bylaw_info->percent_community_fund).' percent';

      $percent_community_funds2=$bylaw_info->percent_community_fund.'%';

    }



    if($bylaw_info_previous->percent_optional_fund!=$bylaw_info->percent_optional_fund)

    {

      $percent_optional_fund='<strong>'.num_format_custom($bylaw_info->percent_optional_fund).' percent</strong>';

       $percent_optional_fund2='<strong>'.$bylaw_info->percent_optional_fund.'%</strong>'; 
...

    {
      ...
      $percent_optional_fund=num_format_custom($bylaw_info->percent_optional_fund).' percent';

       $percent_optional_fund2=$bylaw_info->percent_optional_fund.'%';
    ...
    <div class="col-sm-12 col-md-12">
      ...
      <ol class="text-justify" type="a">
        ...
        <li> <i class="font-weight-bold">Reserve Fund.</i> <?= ucwords($percent_reserve_fund)?> (<?=$bylaw_info->percent_reserve_fund2?>) shall be set aside for Reserve Fund. Provided, that in the first five (5) years of operation after registration, this amount shall not be less than fifty percent (50%) of the net surplus. The reserve fund shall be subjected to the following rules:
        ...
        <li><i class="font-weight-bold">Education and Training Fund.</i> 
          ...
          <?php $percent_educ_fund = ($bylaw_info->percent_education_fund!=$bylaw_info_previous->percent_education_fund ? "<b>".ucwords(num_format_custom($bylaw_info->percent_education_fund))."</b>" : ucwords(num_format_custom($bylaw_info->percent_education_fund))); // ucwords(num_format_custom(($bylaw_info->percent_education_fund)))
        ...
        <li><i class="font-weight-bold">Community Development Fund.</i> <?= ucwords( $percent_community_funds)?>  (<?= $percent_community_funds2?>) shall be used for projects and activities that will benefit the community where the Cooperative operates. </li>

        <li><i class="font-weight-bold">Optional Fund, Land and Building and any other necessary fund.</i> <?=ucwords($percent_optional_fund)?>  (<?=$percent_optional_fund2?>) shall be set aside for this purpose.</li>
  ...
  <div class="row">
    ...
    $non_member_patron_years2='';

    if($bylaw_info_previous->non_member_patron_years!=$bylaw_info->non_member_patron_years)

    {

      $non_member_patron_years='<strong>'.num_format_custom($bylaw_info->non_member_patron_years).'</strong>';

      $non_member_patron_years2='<strong>'.$bylaw_info->non_member_patron_years.'</strong>';
  ...
  <div class="row mb-2">
    ...
    if($bylaw_info_previous->amendment_votes_members_with!=$bylaw_info->amendment_votes_members_with)

    {

      $bylaw_info->amendment_votes_members_with = '<strong>'.$bylaw_info->amendment_votes_members_with.'</strong>';
        ...
        <table class="table table-bordered table-sm table-cooperator">
          ...
          <tbody>
            ...
            <?php /* $count=1; foreach($cooperators_list_regular as $key=> $cooperator) :
                ...
                if(isset($cooperators_list_regular_previous[$key]))

                {

                  $cooperator_previous = $cooperators_list_regular_previous[$key];

            ?>

                   <td><?=$count.'. '.($cooperator['full_name']!=$cooperator_previous['full_name']?'<strong>'.$cooperator['full_name'].'<strong>' : $cooperator['full_name'])?></td>
