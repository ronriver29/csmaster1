...
<div class="container-fluid text-monospace" id="printPage">
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">BY-LAWS<br>OF<br><?= $coop_info->proposed_name?> Youth <?= $coop_info->type_of_cooperative?> Cooperative <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> <?= $coop_info->grouping?></p>
    </div>
  </div>
  <div class="row mb-2">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">We, the undersigned Filipino citizens, of legal age, and residents of the Philippines, representing at least majority of the members of this Youth <?= $coop_info->type_of_cooperative?> Cooperative, do hereby adopt this By-laws.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">Article I<br>Purposes and Goals</p>
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
      <p class="text-justify" style="text-indent: 50px;">The purposes and goals of this Cooperative are those set forth in its Articles of Cooperation.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify font-weight-regular">Section 1. <i class="font-weight-bold">Kinds of Membership.</i> This Cooperative shall have <?php  echo ($bylaw_info->kinds_of_members == 1)? "regular members" : "regulars and associate members";?>. <label style="color:red;"><i>(Admission of associate member is not allowed upon registration)</i></label></p>
      ...
      <p class="text-justify" style="text-indent: 50px;">Associate Members are those member of a cooperative who opts to continue to be a member upon reaching the age of 36. He/she has no right to vote nor be voted upon but is entitled to limited rights, privileges and membership duration as provided in the By-laws of the cooperative, the Philippine Cooperative Code of 2008, and its Implementing Rules and Regulations. </p>
      <p class="text-justify" style="text-indent: 50px;">Associate members of a youth cooperative may form its Board of Elders to provide guidance and advice to the youth cooperative.</p>
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-12">
      <p class="text-justify" style="text-indent: 50px;">Failure of the regular member to meet any of the above conditions shall mean suspension of voting rights until the same have been lifted upon the determination of the Board of Directors.</p>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li>Presentation and approval of the reports of the Board of Directors, officers, and the committees, including Cooperative Annual Progress Report and all other required reports; </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li>Has continuously patronized the Cooperative services;</li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 7. <i class="font-weight-bold">Election of Officers within the Board</i> The Board of Directors shall convene within ten (10) days after the General Assembly meeting to elect by secret ballot from among themselves the Chairperson and the ViceChairperson, and to elect or appoint the Secretary and Treasurer from outside of the Board.</p>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li>Supervise the conduct, manner and proceedings  of election and other election- related activities and act on the changes thereto;</li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li>Recommend to the Board of Directors any member of the cooperative for Conciliation-Mediation Training as Cooperative Mediator-Conciliator; </li>
...
<?php } //end if credit ?>
  ...
  ?>
    <div class="row">
      <div class="col-sm-12 col-md-12 text-left">
          <p class="text-justify font-weight-regular">Section <?php echo $count_row++;?>. <i class="font-weight-bold">Other Committees.</i> The Board of Directors may create such other committees as may be deemed necessary for the operation of the Cooperative.</p>
      </div>
    </div>
    <div class="row mb-4">
      <div class="col-sm-12 col-md-12 text-left">
    ...
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        ...
        <li><i class="font-weight-bold">Vice-Chairperson </i>–the Vice-Chairperson shall:
          <ol type="i">
            <li>Perform all duties and functions of the Chairperson in the absence of the latter; and </li>
            <li>Perform such other duties as may be delegated to him/her by the Board of Directors. </li>
          </ol>
        </li>
        ...
        <li><i class="font-weight-bold">Treasurer</i> – The Treasurer shall:
          <ol type="i">
            ...
            <li>vii.  Perform such other functions as may be prescribed in the By-laws or authorized by the Board of Directors.</li>
          </ol>
        </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li>Bachelors degree in accountancy must be required for Accountant however Cashier and Bookkeeper must be knowledgeable in handling monetary transactions, accounting and/or bookkeeping, respectively; </li>
