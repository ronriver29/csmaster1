...
<!-- <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>cooperatives/<?= $encrypted_cid ?>/documents" role="button"><i class="fas fa-arrow-left"></i> Go Back</a> -->
<?php } ?>
</head>
