...
<div class="container-fluid text-monospace">
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">BY-LAWS<br>OF<br><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?= $coop_info->grouping?></p>
    </div>
  </div>
  <div class="row mb-2">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">We, the undersigned Filipino citizens, of legal age, and residents of the Philippines, representing at least majority of the members of this <b><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?= $coop_info->grouping?></b>, do hereby adopt this By-laws.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify font-weight-regular">Section 1. <i class="font-weight-bold">Kinds of Membership.</i> This Cooperative shall have <b><?php  echo ($bylaw_info->kinds_of_members == 1)? "regular members only" : "regulars and associate members";?></b>.</p>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
        <p class="text-justify font-weight-regular">Section 4. <i class="font-weight-bold">Application for Membership.</i> An applicant for membership shall file a duly accomplished form to the Board of Directors who shall act upon the application within <b><?= ucwords(num_format_custom($bylaw_info->act_upon_membership_days));?></b> (<b><?= $bylaw_info->act_upon_membership_days?></b>) days from the date of filing. The Board of Directors shall devise a form for the purpose which shall, aside from the profile of the applicant cooperative, include the duties of an affiliate to participate in all programs including but not limited to capital build-up, patronizing the businesses and services and savings mobilization of the federation and, such other information as may be deemed necessary. </p>
        <p class="text-justify" style="text-indent: 50px;">The application form for membership shall include an undertaking to uphold the By-laws, policies, guidelines, rules and regulations promulgated by the Board of Directors and the general assembly. No application for membership shall be given due course if not accompanied with a membership fee of <b><?= ucwords(num_format_custom(str_replace(',','',$bylaw_info->membership_fee)));?></b> (<b>Php <?= number_format(str_replace(',','',$bylaw_info->membership_fee),2)?></b>), which shall be refunded to the applicant cooperative in case of rejection.</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify font-weight-regular">Section 6. <i class="font-weight-bold">Minimum Share Capital Requirement.</i> An applicant for <strong>regular membership</strong> shall subscribe at least <b><?= num_format_custom($bylaw_info->regular_percentage_shares_subscription)?></b> (<b><?= $bylaw_info->regular_percentage_shares_subscription?></b>) shares and pay the value of at least <b><?= num_format_custom($bylaw_info->regular_percentage_shares_pay)?></b> (<b><?= $bylaw_info->regular_percentage_shares_pay?></b>) shares upon approval of his/her membership.</p>
      <?php if($bylaw_info->kinds_of_members == 2) :?>
      <p class="text-justify">An applicant for <strong>associate membership</strong> shall subscribe at least <b><?= num_format_custom($bylaw_info->associate_percentage_shares_subscription)?></b> (<b><?= $bylaw_info->associate_percentage_shares_subscription?></b>) shares and pay the value of at least <b><?= num_format_custom($bylaw_info->associate_percentage_shares_pay)?></b> (<b><?= $bylaw_info->associate_percentage_shares_pay?></b>) shares upon approval of his/her membership.</p>
      <?php endif;?>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 4. <i class="font-weight-bold">Regular General Assembly Meeting.</i> The General Assembly shall hold its annual regular meeting every <b><?= $bylaw_info->annual_regular_meeting_day ?></b> at the principal office of the Cooperative or at any place as may be determined by the Board. </p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 8. <i class="font-weight-bold">Quorum for General Assembly Meeting.</i> During regular or special general assembly meeting, at least <b><?= num_format_custom($bylaw_info->members_percent_quorom)?> percent</b> (<b><?= $bylaw_info->members_percent_quorom?>%</b>) of the total number of members entitled to vote shall constitute a quorum. </p>
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 1. <i class="font-weight-bold">Composition of the Board of Directors (BOD).</i> The Board of Directors shall be composed of <b><?= num_format_custom($no_of_directors)?></b> (<b><?= $no_of_directors?></b>) members.</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <ol class="text-justify" type="a">
        <li>Holding any elective position in the government, except that of a party list representative being an officer of a Cooperative he/she represents; </li>
    		...
    		<li>Having direct or indirect personal interest with the business of the Cooperative; </li>
      		<li>Having been absent for <b><?= num_format_custom($bylaw_info->number_of_absences_disqualification) ?></b>(<b><?= $bylaw_info->number_of_absences_disqualification ?></b>) consecutive meetings or in more than <b><?=num_format_custom($bylaw_info->percent_of_absences_all_meettings) ?> percent</b> (<b><?= $bylaw_info->percent_of_absences_all_meettings.'%'?></b>) of all meetings within the twelve (12) month period unless with valid excuse as approved by the Board of Directors;</li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li>At least <b><?=ucwords(num_format_custom($bylaw_info->member_invest_per_month))?> Pesos</b> (P<b><?=$bylaw_info->member_invest_per_month?></b>)per month; </li>
    		<li>At least <b><?=ucwords(num_format_custom($bylaw_info->member_percentage_annual_interest))?> percent</b> (<b><?=$bylaw_info->member_percentage_annual_interest?>%</b>) of his/her annual interest on capital and patronage refund; and </li>
    		<li>At least <b><?=ucwords(num_format_custom($bylaw_info->member_percentage_service))?> percent</b> (<b><?=$bylaw_info->member_percentage_service?>%</b>) of each good procured /service acquired from the cooperative. </li>
  		</ol>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li> <i class="font-weight-bold">Reserve Fund.</i> <b><?= ucwords(num_format_custom($bylaw_info->percent_reserve_fund))?> percent</b> (<b><?=$bylaw_info->percent_reserve_fund?>%</b>)shall be set aside for Reserve Fund. Provided, that in the first five (5) years of operation after registration, this amount shall not be less than fifty percent (50%) of the net surplus. The reserve fund shall be subjected to the following rules:
    			<ol type="i">
        ...
        <li><i class="font-weight-bold">Education and Training Fund.</i> <b><?= ucwords(num_format_custom($bylaw_info->percent_education_fund))?> percent</b> (<b><?=$bylaw_info->percent_education_fund?>%</b>)shall be set aside for Education and Training Fund.
          <ol type="i">
        ...
        <li><i class="font-weight-bold">Community Development Fund.</i> <b><?= ucwords(num_format_custom($bylaw_info->percent_community_fund))?> percent</b> (<b><?=$bylaw_info->percent_community_fund?>%</b>) shall be used for projects and activities that will benefit the community where the Cooperative operates. </li>
        <li><i class="font-weight-bold">Optional Fund, Land and Building and any other necessary fund.</i> <b><?=ucwords(num_format_custom($bylaw_info->percent_optional_fund))?> percent</b> (<b><?=$bylaw_info->percent_optional_fund?>%</b>)shall be set aside for this purpose.</li>
    	</ol>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li>In the case of a member patron with paid-up share capital contribution, his/her proportionate amount of patronage refund shall be paid to him/her unless he/she agrees to credit the amount to his/her account as additional share capital contribution; </li>
    		...
    		<li>In the case of non-member patron, his/her proportionate amount of patronage refunds shall be set aside in a general fund for such patron and shall be allocated to individual non-member patron and only upon request and presentation of evidence of the amount of his/her patronage. The amount so allocated shall be credited to such patron toward payment of the minimum capital contribution for membership. When a sum equal to this amount has accumulated at any time within <b><?= num_format_custom($bylaw_info->non_member_patron_years)?></b> (<b><?=$bylaw_info->non_member_patron_years ?></b>) years, such patron shall be deemed and become a member of the Cooperative if he/she so agrees or requests and complies with the provisions of the bylaws for admission to membership; and</li>
        ...
        <table class="table table-bordered table-sm table-cooperator">
          ...
          <tbody>
            <?php foreach($cooperators_list as $cooperator) :?>
              <tr>
                <td><b><?=$cooperator['full_name']?></b></td>
                <td></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify mb-4" style="text-indent: 50px;">We, constituting the majority of the Board of Directors of the <b><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?= $coop_info->grouping?></b> do hereby certify that the foregoing instrument is the Code of By-laws of this Cooperative.</p>
