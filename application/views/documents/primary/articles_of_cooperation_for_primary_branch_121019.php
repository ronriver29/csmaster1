...
<div class="container-fluid text-monospace">
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">ARTICLES OF COOPERATION<br>of<br><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative <?= $coop_info->grouping?></p>
    </div>
  </div>
  <div class="row mb-2">
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-12">
      <p class="text-justify" style="text-indent: 50px;">That the name of this Cooperative shall be  <strong><?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative <?= $coop_info->grouping?></strong></p>
    </div>
  </div>
  <div class="row  mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">The term for which this Cooperative shall exist is <b><?= ucwords(num_format_custom($article_info->years_of_existence))?> (<?= $article_info->years_of_existence?>) years</b> from the date of its registration with the Cooperative Development Authority.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">That the common bond of membership of this Cooperative is <b><?= $coop_info->common_bond_of_membership?></b> and the field of membership shall be open to all <b><?php foreach($members_composition as $compo) : ?>
          <?= $compo['composition'] ?>,
          <?php endforeach; ?></b> who are natural persons, Filipino citizens, of legal age, with the capacity to contract and possess all the qualifications and none of the disqualifications provided for in the By-laws and this Articles of Cooperation.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">That the membership of this Cooperative shall come from
       <b><?php if($coop_info->area_of_operation=="Barangay"){
       ...
       ?></b>. Its principal office shall be located at <?php if($coop_info->house_blk_no==null && $coop_info->street==null) $x=''; else $x=', ';?><b><?=$coop_info->house_blk_no?> <?=ucwords($coop_info->street).$x?> <?=$coop_info->brgy?> <?=$coop_info->city?> <?= $coop_info->province?> <?=$coop_info->region?></b>.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">That the number of Directors of this Cooperative shall be <b><?=num_format_custom($no_of_directors)?></b>(<b><?= $no_of_directors?></b>) and shall serve until their successors shall have been elected and qualified within <b><?=$article_info->directors_turnover_days?></b> days from the date of registration as provided in the By-laws.</p>
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            <?php $count=0; foreach($directors_list as $director) :?>
              <?=$count++;?>
            <tr>
              <td><b><?=$count.'. '.$director['full_name']?></b></td>
            </tr>
          <?php endforeach;?>
          </tbody>
        </table>
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">That the Authorized Share Capital of this Cooperative is <b><?= ucwords(num_format_custom($article_info->authorized_share_capital))?> PESOS</b> (<b>Php <?=number_format($article_info->authorized_share_capital,2)?></b>), divided into:</p>
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li> <b><?= ucwords(num_format_custom($article_info->common_share))?></b> (<b><?= number_format($article_info->common_share,2)?></b>) common shares with a par value of <b><?= ucwords(num_format_custom($article_info->par_value_common))?></b> (<b>Php <?=number_format($article_info->par_value_common,2)?></b> ) per share;</li>
        <?php if($bylaw_info->kinds_of_members == 2) :?>
        <li> <b><?= ucwords(num_format_custom($article_info->preferred_share))?></b> (<b><?= number_format($article_info->preferred_share,2)?></b>) preferred shares with a par value of <b><?= ucwords(num_format_custom($article_info->par_value_preferred))?></b> (<b>Php <?=number_format($article_info->par_value_preferred,2)?></b> ) per share.</li>
        <?php endif;?>
      </ol>
    </div>
  </div>
  ...
  <div class="row ">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">That of the authorized share capital, the amount of
        <b><?php echo ucwords(num_format_custom(($bylaw_info->kinds_of_members == 1) ? $total_regular['total_subscribed'] * $article_info->par_value_common : ($total_regular['total_subscribed'] * $article_info->par_value_common) + ($total_associate['total_subscribed'] * $article_info->par_value_preferred)));?></b>
        (<b>Php <?php echo ($bylaw_info->kinds_of_members == 1) ? number_format(($total_regular['total_subscribed'] * $article_info->par_value_common),2) : number_format((($total_regular['total_subscribed'] * $article_info->par_value_common) + ($total_associate['total_subscribed'] * $article_info->par_value_preferred)),2);?></b>) has been subscribed, and
        <b><?php echo ucwords(num_format_custom(($bylaw_info->kinds_of_members == 1) ? ($total_regular['total_paid'] * $article_info->par_value_common) : ($total_regular['total_paid'] * $article_info->par_value_common) + ($total_associate['total_paid'] * $article_info->par_value_preferred)));?></b>
        (<b>Php <?php echo ($bylaw_info->kinds_of_members == 1) ? number_format(($total_regular['total_paid'] * $article_info->par_value_common),2) : number_format((($total_regular['total_paid'] * $article_info->par_value_common) + ($total_associate['total_paid'] * $article_info->par_value_preferred)),2);?></b>) of the total subscription has been paid by the following members-subscribers:</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <table class="table table-sm">
          ...
          <tbody>
            <?php $count=0; foreach($regular_cooperator_list as $regular) : ?>
              <?php $count++; ?>
            <tr>
              <td><b><?=$count.'. '. $regular['full_name']?></b></td>
          ...
          <tfoot>
            <tr>
              <th><b>Sub Total</b></th>
              <th style="text-align: center;"><b><?= $total_regular['total_subscribed']?></b></th>
              <th style="text-align: right;"><b><?= number_format(($total_regular['total_subscribed'] * $article_info->par_value_common),2)?></b></th>
              <th style="text-align: center;"><b><?= $total_regular['total_paid'] ?></b></th>
              <th style="text-align: right;"><b><?= number_format(($total_regular['total_paid'] * $article_info->par_value_common),2)?></b></th>
            </tr>
          </tfoot>
        </table>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-sm">
          ...
          <tfoot>
            <tr>
              <th><b>Sub Total</b></th>
              <th style="text-align: center;"><b><?= $total_associate['total_subscribed']?></b></th>
              <th style="text-align: right;"><b><?= number_format(($total_associate['total_subscribed'] * $article_info->par_value_preferred),2)?></b></th>
              <th style="text-align: center;"><b><?= $total_associate['total_paid'] ?></b></th>
              <th style="text-align: right;"><b><?= number_format(($total_associate['total_paid'] * $article_info->par_value_preferred),2)?></b></th>
            </tr>
            <tr>
              <th><b>Grand Total</b></th>
              <th style="text-align: center;"><b><?= $total_regular['total_subscribed'] + $total_associate['total_subscribed']?></b></th>
              <th style="text-align: right;"><b><?= number_format((($total_regular['total_subscribed'] * $article_info->par_value_common) + ($total_associate['total_subscribed'] * $article_info->par_value_preferred)),2)?></b></th>
              <th style="text-align: center;"><b><?= $total_regular['total_paid'] + $total_associate['total_paid']?></b></th>
              <th style="text-align: right;"><b><?= number_format((($total_regular['total_paid'] * $article_info->par_value_common) + ($total_associate['total_paid'] *  $article_info->par_value_preferred)),2)?></b></th>
            </tr>
          </tfoot>
        </table>
      </div>
  ...
  <div class="row mb-3">
    <div class="col-sm-12 col-md-12 text-left">
      <p class="text-justify" style="text-indent: 50px;">This instrument known as Article of Cooperation of <?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Cooperative, consists of ______ pages including this page where the acknowledgment is written signed by parties and their instrumental witnesses on each and every page thereof.</p>
    </div>
  </div>
  <div class="row mb-3">
    <div class="col-sm-12 col-md-12 text-left">
