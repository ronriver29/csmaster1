...
<div class="container-fluid text-monospace">
  ...
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
      <p class="text-justify" style="text-indent: 50px;">The purpose/s and goals of this Cooperative Union are those set forth in its Articles of Cooperation.</p>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
    		...
    		<li> Evaluate the capability and qualification and recommend to the General Assembly the engagement of the services of the External Auditor; </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify" style="text-indent: 50px;">Majority of the total number of directors constitutes a quorum to transact business of the meeting. Any decision or action taken by the majority members of the Board of Directors in a meeting duly assembled shall be a valid cooperative act.</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
    ...
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li> Monitor the adequacy and effectiveness of the Cooperative Union’s management and control system; </li>
    		...
    		<li> Submit reports on the results of the internal audit and recommend necessary changes on policies and other related matters on operation to the Board of Directors and General Assembly; </li>
  ...
  <div class="row mb-2">
    <div class="col-sm-12 col-md-12 text-center">
        <p class="font-weight-bold">Article VI<br>Officers and Management Staff<br>of the Cooperative Union</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
      ...
      <ol class="text-justify" type="a">
        <li><i class="font-weight-bold">Chairperson</i> – The Chairperson shall:
      		<ol type="i">
      			...
      			<li>Sign contracts, agreements, certificates and other documents on behalf of the cooperative Union as authorized by the Board of Directors or by the GA; and </li>
      	...
      	<li><i class="font-weight-bold">Treasurer</i> – The Treasurer shall:
      		<ol type="i">
      			...
      			<li> Monitor and review the financial management operations of the Cooperative Union, subject to such limitations and control as may be prescribed by BOD; </li>
      	...
      	<li><i class="font-weight-bold">Secretary</i> – The Secretary shall:
      	 ...
      	 <li><i class="font-weight-bold">General Manager</i>. The General Manager shall:
      		<ol type="i">
      			...
      			<li>Formulate and recommend in coordination with the operating departments under his/her supervision, the Cooperative Union’s Annual and Medium Term Development. Plan, programs and projects, for approval of the BOD, and ratification of GA; </li>
      			<li>Implement the duly approved plans and programs of the Cooperative Union and any other directive or instruction of the BODs; </li>
      			<li>Provide and submit to the BODs monthly reports on the status of the Cooperative Union's operation vis-a-vis its target and recommend appropriate policy or operational changes, if necessary;</li>
      			<li>Represent the Cooperative Union in any agreement, contract, business  dealings, and in any other official business transaction as may be authorized by the BODs; </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 5. <i class="font-weight-bold">Duties of the Bookkeeper.</i> The bookkeeper of the Cooperative Union who is under supervision and control of the Chief Operating Officer shall:</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li>Records and update books of accounts; </li>
    		<li>Provide assistance in the preparation of reports on the financial condition and operations of the Cooperative Union monthly, annually or as may be required by the Board of Directors and/or the general assembly; </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        <p class="text-justify font-weight-regular">Section 8. <i class="font-weight-bold">Qualifications of Bookkeeper.</i> No person shall be appointed to the position of bookkeeper unless he/she possess the following qualifications and none of the disqualifications herein enumerated: </p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li> Must be knowledgeable in handling bookkeeping and accounting works; </li>
    		<li>Must have at least two (2) years experience in Cooperative Union or related activities; </li>
  ...
  <div class="row">
    <div class="col-sm-12 col-md-12 text-left">
        ...
        <p class="text-justify" style="text-indent: 50px;">The Cooperative Union shall submit the following reports to the Authority within (120) days from the end of every calendar year:</p>
    </div>
  </div>
  <div class="row mb-4">
    <div class="col-sm-12 col-md-12">
      <ol class="text-justify" type="a">
        <li>Cooperative Annual Performance Report (CAPR); </li>
    		...
    		<li>Consultancy assistance to include the nature and cost; and </li>
