<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <?php if($branch_info->status == 43 && !$is_client){ ?>
    ...
    <?php } else if(($branch_info->status >= 40) && $is_client){ ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_branch_id ?>/bns_transfer" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } else if($branch_info->status == 49 || $branch_info->status == 54){ ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_branch_id ?>/bns_transfer" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } else { ?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>for_transfer" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php }?>
    ...
    <hr>
    <?php else :?>
      <?php if(($branch_info->status == 23 || $branch_info->status == 24 || $branch_info->status != 42) && $branch_info->status >= 45 && $branch_info->status != 48){ ?>
      ...
      <?php if($admin_info->access_level !=5 && $branch_info->status != 23 && $branch_info->status != 24 && $branch_info->status != 21) : ?>
        <div class="btn-group float-right" role="group" aria-label="Basic example">
          <?php if($branch_info->status>41) echo '<a class="btn btn-info btn-sm" href="'.base_url().'branches/'.$encrypted_branch_id.'/cooperative_tool/branch_transfer">Validation Tool</a>';
          ?>
        <?php
        if($branch_info->status != 18 && $branch_info->status != 23 && $branch_info->status == 41){
            if($admin_info->access_level == 3){
                $submit = 'Received';
            } else {
...
<?php if(strlen((($branch_info->comment_by_senior_level1 OR $branch_info->migrated == 1) && $admin_info->access_level==3)) && $branch_info->status == 42 || ($branch_info->status == 45 && $admin_info->access_level==1 && ($branch_info->comment_by_senior_level1 OR $branch_info->migrated == 1)) || ($branch_info->status == 46 && $admin_info->access_level==2 && ($branch_info->comment_by_senior_level1 OR $branch_info->migrated == 1)) || ($branch_info->status == 47 && ($admin_info->access_level==3 || $admin_info->access_level==4) && ($branch_info->comment_by_senior_level1 OR $branch_info->migrated == 1))) : ?>
...
<?php endif;?>
<?php if(strlen((($branch_info->comment_by_specialist || $branch_info->migrated == 1) && $admin_info->access_level==2) || $admin_info->access_level==3) && $branch_info->status == 46 || ($branch_info->status == 47 && ($admin_info->access_level==3 || $admin_info->access_level==4) && ($branch_info->comment_by_senior_level1 OR $branch_info->migrated == 1))) : ?>
  ...
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue shadow-sm mb-4">
      ...
      <div class="card-body">
        ...
        <hr>
        <strong>Address to be transferred</strong>
        <p class="text-muted">
          <?php if($branch_trans->transferred_houseblk==null && $branch_trans->transferred_street==null) $x=''; else $x=', ';?>
          <?=ucwords($branch_trans->transferred_houseblk)?> <?=ucwords($branch_trans->transferred_street).$x?> <?=$branch_trans->brgy.', '?> <?=$branch_trans->city.', '?> <?= $branch_trans->province.', '?> <?=$branch_trans->region?>
        </p>
        <hr>
...
<div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">
              ...
              <?php if(isset($document_letter_of_intent)) : ?>
               <!--  <a target="_blank" href="<?php echo base_url();?>cooperatives/<?=$encrypted_id?>/documents/view_document_one/<?= encrypt_custom($this->encryption->encrypt($document_one->filename))?>"> -->
                 ...
                 <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_id_others?>/43">
          ...
          <?php if($is_client && $branch_info->status==40): ?>
            <?php if($is_client) : ?>
                <a href="<?php echo base_url();?>branches/<?=$encrypted_id_others?>/documents_transfer/upload_document_letter_of_intent" class="btn btn-primary">Upload</a>
            <?php endif;?>
          <?php endif; ?>
...
<hr>
<?php
if($branch_info->status == 33 || $branch_info->status == 43 || $branch_info->status == 45 || $branch_info->status == 46 || $branch_info->status == 47 || $branch_info->status == 48 || $branch_info->status == 49){ ?>
  <div class="row">
    <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Copy of the Notice of Transfer</h5>
          <p class="card-text">
            <?php if($document_47) : ?>
  <!--            Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_5/<?= encrypt_custom($this->encryption->encrypt($document_5->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/47">
          ...
          <?php if($is_client && $branch_info->status==43 || $branch_info->status == 49): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_transfer_submission/upload_document_for_transfer_47" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <?php if($document_48) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_6/<?= encrypt_custom($this->encryption->encrypt($document_6->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/48">
          ...
          <?php if($is_client && $branch_info->status==43 || $branch_info->status == 49): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_transfer_submission/upload_document_for_transfer_48" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <?php if($document_49) : ?>
              <!--Modify by anjury-->
              <!--<a target="_blank" href="<?php echo base_url();?>branches/<?=$encrypted_id?>/documents/<?=$encrypted_branch_id?>/view_document_7/<?= encrypt_custom($this->encryption->encrypt($document_7->filename))?>">-->
              <a target="_blank" href="<?php echo base_url();?>documents_transfer/list_upload_pdf_branch/<?=$encrypted_branch_id?>/49">
          ...
          <?php if($is_client && $branch_info->status==43 || $branch_info->status == 49): ?>
            <a href="<?php echo base_url();?>branches/<?=$encrypted_branch_id?>/documents_transfer_submission/upload_document_for_transfer_49" class="btn btn-primary">Upload</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
