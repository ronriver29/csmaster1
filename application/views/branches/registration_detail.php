            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                  ...
                  <input type="hidden" class="custom-select validate[required]" name="barangay2" id="barangay2" value="<?=$coopreg_info->addrCode?>">
                  <input type="hidden" class="custom-select validate[required]" name="barangay" id="barangay2" value="<?=$coopreg_info->addrCode?>">
              ...
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                  <input type="hidden" class="custom-select validate[required]" name="region2" id="region2" value="<?=$coopreg_info->rCode?>">
                </div>
              </div>
            </div>
          </div>
