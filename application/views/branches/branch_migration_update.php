<div class="row mb-2">
  <div class="col-sm-12 col-md-2">
    <a class="btn btn-secondary btn-sm btn-block"  href="<?php echo base_url();?>branch_update/<?=$encrypted_id?>/view" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('branch_update/'.$encrypted_id.'/bupdate',array('id'=>'reserveBranchUpdateForm','name'=>'reserveBranchUpdateForm')); ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="coopname" value="<?=$branch_info->coopName?>">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="<?=$branch_info->branchName?>" name="branchName">
                </div>
              </div>
            </div>
              <?php
              ...
              if($branch_info->type == 'Satellite'){
                $satellite_selected = 'selected';
              } else {
                $satellite_selected = '';
              }
              ?>
                ...
                <div class="form-group">
                  <label>Type</label>
                    <select class="custom-select validate[required]" name="typeOfbranchsatellite" id="typeOfbranchsatellite" >
                          <option value="">--</option>
                          <option value="Branch" <?=$branch_selected?>>Branch</option>

                          <option value="Satellite" <?=$satellite_selected?>>Satellite</option>
