       ...
       <!--   <li>
         ...
         <!-- <li>
          ...
          <ul class="collapse list-unstyled" id="pagePayments">
            <li>
              <a href="<?php echo base_url();?>payment_inquiry/cooperatives_inquiry"><i class="fas fa-cog"></i> Cooperatives</a>
            </li>
            <li>
              <a href="<?php echo base_url();?>payment_inquiry/bns_inquiry"><i class="fas fa-cog"></i> Branch/Satellite</a>
            </li>
            <li>
              <a href="<?php echo base_url();?>payment_inquiry/laboratory_inquiry"><i class="fas fa-cog"></i> Laboratory</a>
            </li>
            <li>
              <a href="<?php echo base_url();?>payment_inquiry/amendment_inquiry"><i class="fas fa-cog"></i> Amendment</a>
            </li>
            <!-- <li>
              <a href="<?php echo base_url();?>amendment/deferred_denied"><i class="fas fa-cog"></i> Deferred / Denied</a>
            </li>
