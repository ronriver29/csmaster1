          ...
          <?php echo form_open('affiliators/edit_affiliators',array('id'=>'editAffiliatorForm','name'=>'editAffiliatorForm')); ?>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="number" min="1" max="<?=isset($capitalization_info->total_no_of_subscribed_capital) ? $capitalization_info->total_no_of_subscribed_capital - $total_subscribed: ''?>" class="form-control validate[required,min[1],custom[integer]]" id="subscribedShares2" name="subscribedShares2">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="number" min="1" max="<?=isset($capitalization_info->total_no_of_paid_up_capital) ? $capitalization_info->total_no_of_paid_up_capital - $total_paid: ''?>" class="form-control validate[required,min[1],custom[integer],funcCall[validateAddNumberOfPaidUpGreaterCustom]]" id="paidShares2" name="paidShares2">
