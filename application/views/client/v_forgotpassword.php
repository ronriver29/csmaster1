  ...
  <div class="col-sm-12 offset-md-4 col-md-4">
    <div class="card login-card shadow border-top-blue">
          <div class="card-body text-center">
              ...
              <input class="btn btn-lg btn-primary btn-block btn-color-blue" type="submit" name="submit-email-client"></button>
            <?php echo form_close(); ?>
            ...
            <a class="btn btn-linnk" href="<?php echo base_url();?>welcome">Home Page</a><br>
             <a class="btn btn-link" href="<?php echo base_url();?>users/login" role="button">Login</a>
