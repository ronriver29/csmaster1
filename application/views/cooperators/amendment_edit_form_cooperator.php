...
<?php $total_subscribed_previous = 0;?>

<?php $total_paid_previous = 0;?>
...
<?php foreach ($list_cooperators_previous as $cooperator_previous) : ""?>

    <?php 

        $total_subscribed_previous += $cooperator_previous['number_of_subscribed_shares'];

        $total_paid_previous += $cooperator_previous['number_of_paid_up_shares'];
  ...
  <div class="col-sm-12 col-md-12">
    ...
    <strong>Reminder: <small>(The information below is in your bylaws (capitalization))</small></strong>
     ...
     <ul>
       ...
       <li>Regular Member must subscribed at least <strong><?= $capitalization_info_previous->minimum_subscribed_share_regular?></strong> shares and pay at least <strong><?= $capitalization_info_previous->minimum_paid_up_share_regular?></strong> shares.</li>

       <?php if($bylaw_info_previous->kinds_of_members ==2) : ?>

        <li>Associate Member must subscribed at least  <strong><?= $capitalization_info_previous->minimum_subscribed_share_associate?></strong> shares and pay at least <strong><?= $capitalization_info_previous->minimum_paid_up_share_associate?></strong> shares.</li>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <?php 
            ...
            $cooperator_info_previous_number_of_subscribed_shares =0;

            $cooperator_info_previous_number_of_paid_up_shares = 0;

            if(isset($cooperator_info_previous))

            {

              $cooperator_info_previous_number_of_subscribed_shares =$cooperator_info_previous->number_of_subscribed_shares;

               $cooperator_info_previous_number_of_paid_up_shares = $cooperator_info_previous->number_of_paid_up_shares;
            ...
            $available_subscribed_capital = isset($capitalization_info->total_no_of_subscribed_capital) ? (($capitalization_info->total_no_of_subscribed_capital - $total_subscribed)>=0 ? ($capitalization_info->total_no_of_subscribed_capital - $total_subscribed) + $cooperator_info->number_of_subscribed_shares : '') : '';
             ...
             $available_subscribed_capital_previous = isset($capitalization_info_previous->total_no_of_subscribed_capital) ? (($capitalization_info_previous->total_no_of_subscribed_capital - $total_subscribed_previous)>=0 ? ($capitalization_info_previous->total_no_of_subscribed_capital - $total_subscribed_previous) + $cooperator_info_previous_number_of_subscribed_shares : '') : '';
            ...
            $available_paid_up_capital = isset($capitalization_info->total_no_of_paid_up_capital) ? (($capitalization_info->total_no_of_paid_up_capital - $total_paid)>=0 ? ($capitalization_info->total_no_of_paid_up_capital - $total_paid) + $cooperator_info->number_of_paid_up_shares : '') : '';
             ...
             $available_paid_up_capital_previous = isset($capitalization_info_previous->total_no_of_paid_up_capital) ? (($capitalization_info_previous->total_no_of_paid_up_capital - $total_paid_previous)>=0 ? ($capitalization_info_previous->total_no_of_paid_up_capital - $total_paid_previous) +  $cooperator_info_previous_number_of_paid_up_shares : '') : '';
          ...
          <div class="col-sm-12 col-md-4"> 
            ...
            <div class="form-group">
              ...
              <input type="hidden" id="is_previousinal_cooperator" value="<?=$is_previousinal_cooperator?>">

              <label for="subscribedShares">No of subscribed shares:</label>

              <?php 

              if(!$is_previousinal_cptr)
              ...
              <input type="number" value="<?=$cooperator_info->number_of_subscribed_shares ?>" min="<?=$last_share_amount->number_of_subscribed_shares?>" max="<?=$available_subscribed_capital?>" class="form-control validate[required,min[1],custom[integer]]" id="subscribedShares" name="amd_subscribedShares">
              ...
              <?php
...

               {
                ...
                ?>
                 ...
                 <input type="number" value="<?= $cooperator_info->number_of_paid_up_shares ?>" min="<?=$last_share_amount->number_of_paid_up_shares ?>" max="<?=$available_paid_up_capital?>" class="form-control validate[required,min[1],custom[integer],funcCall[validateEditNumberOfPaidUpGreaterCustom]]" id="paidShares" name="paidShares">
