...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('cooperatives/'.$encrypted_id.'/bylaws_primary',array('id'=>'bylawsPrimaryForm','name'=>'bylawsPrimaryForm')); ?>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              ...
              <select class="custom-select validate[required]" name="amendmentMembersWith" id="amendmentMembersWith" disabled>
                ...
                <option value="Voting Rights" <?php if($bylaw_info->amendment_votes_members_with == "Voting Rights") echo "selected"; ?>>Member Rights</option>
