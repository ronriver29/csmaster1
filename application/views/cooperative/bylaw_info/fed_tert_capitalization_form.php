            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="item[total_amount_of_paid_up_capital]" min="5000000" id="total_amount_of_paid_up_capital" class="form-control" value="<?=$total_amount_of_paid_up_capital;?>"/>
...
//        $("#total_amount_of_paid_up_capital").val(amount_of_paid_up_capital);
        // $("#total_amount_of_paid_up_capital").attr("min",amount_of_paid_up_capital);
        // $("#total_amount_of_paid_up_capital_note2").html("Should be at least "+amount_of_paid_up_capital);
        // $("#total_amount_of_paid_up_capital_note").html("Should be at least "+5000000);
        ...
        if(parseFloat(minimum_amount_of_paid_up_capital)>=5000000){
