  ...
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
               ...
               <textarea class="form-control validate" style="resize: none;" id="delegatePowers" name="delegatePowers" placeholder="Ex. &#10;item 1;&#10;item2;&#10;itemlast."rows="10"></textarea>
        		...
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			...
        			<input type="number" class="form-control validate[required,min[25],max[100],custom[integer]]" id="quorumPercentage" name="quorumPercentage" min="25" placeholder="Enter Percent %">
      ...
      <div class="card-footer addCooperatorFooter">
        <input class="btn btn-color-blue btn-block" type="submit" id="bylawsPrimaryBtn" name="bylawsUnionBtn" value="Submit">
      </div>
    </form>
    </div>
  </div>
