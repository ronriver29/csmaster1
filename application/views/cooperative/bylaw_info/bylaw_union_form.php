      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <input type="text" min="1" value="<?= number_format($bylaw_info->membership_fee,2) ?>" class="form-control" id="membershipFee" name="membershipFee" placeholder="&#8369; 0.00" disabled required>
            ...
            <div class="col-sm-12 col-md-12">
              <div class="form-group">
               ...
               <button type="button" class="btn btn-success btn-block btn-sm float-right" id="addMoredelegatePowersBtn"><i class="fas fa-plus"></i> Add More General Assembly</button>
        		...
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="termHoldDirector"><strong style="color: red;">*</strong><strong> How many days shall the directors serve until their successors shall have been elected and qualified?</strong></label>
