<div class="row">
    ...
    <div class="row mb-2">
      <div class="col-sm-12 col-md-12">
        <?php if($branch_info->status>9) : ?>
          <a class="btn btn-secondary btn-sm float-left" href="<?php echo base_url();?>branches/<?= $encrypted_id ?>/documents_conversion" role="button" style="margin-right: 50px"><i class="fas fa-arrow-left"></i> Go Back</a>
        <?php endif;?>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card mb-4 border-top-blue">
      ...
      <?php echo form_open('cooperative_tool/save_branch_conversion', 'name="toolForm" id="toolForm"');?>
      <div class="card-body">
        <div class="row">
