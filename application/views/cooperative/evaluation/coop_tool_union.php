      ...
      <div class="card-body">
        <div class="row">
          ...
          <table class="table table-bordered" Width="100%">
            ...
            <tr>
              <td colspan="4"><b>A. BASIC KNOWLEDGE ON UNION, ITS FUNCTIONS AND OPERATIONS</b></td>
            </tr>
            <tr>
              <td width="40%" style="padding-left: 30px">1. Basic knowledge on union of cooperatives, functions and operations
              <td width="10%">
            ...
            <tr>
              <td style="padding-left: 30px">1. Proof of compliance to the number of members required for the establishment of a union</td>
              <td width="10%">
            ...
            <tr>
              <td style="padding-left: 30px">2. The General Assembly Resolution contains the following:<br><br>
                <ol type="a">
                  <li>Authorizing membership in the proposed union.</li><br>
                  <li>Authorizing the contribution to union dues to the proposed union. </li>
                </ol>
              </td>
              <td width="10%">
                <ul>
                  <li>GA Resolution that has approved their membership and the amount of dues to the cooperative union,</li><br>
            ...
            <tr>
              <td colspan="4"><b>D. VIABILITY</b></td>
            </tr>
            <tr>
              <td style="padding-left: 30px">1. There is sufficient funding source to cover the cost of operation of the proposed union.
              </td>
              <td width="10%">
                Development Plan
              </td>
            ...
            <tr>
              ...
              <td width="10%">
                <ul>
                  ...
                  <br>
                  <li>Treasurers Affidavit (Legal Basis: MC 2020-23 Art. V, Section 4.)</li>
                </ul>
              </td>
              <?php if ($ans==null){
