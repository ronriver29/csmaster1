<div class="row mb-2">
  <div class="col-sm-12 col-md-2">
    ...
    <?php } else {?>
      <a class="btn btn-secondary btn-sm btn-block"  href="<?php echo base_url();?>branches/<?=$encrypted_id?>/bns_closure" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } ?>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('for_closure/'.$encrypted_id.'/bupdate',array('id'=>'reserveBranchUpdateForm','name'=>'reserveBranchUpdateForm')); ?>
          ...
          <div class="col-sm-12 col-md-12">
            <div class="row">
             ...
             <div class="col-sm-12 col-md-4">
              ...
              <div class="col-sm-12 col-md-12">
                <div class="form-group">
                   <label for="barangay"><i style="color:red;">*</i> Reason / Supporting Sentence / Paragraph of Transfer</label>
                        <textarea class="form-control" name="reason" id="reason" required=""><?=$branch_info->reason?></textarea>
                </div>
              </div>
            </div>
          </div>
