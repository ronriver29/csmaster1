...
<?php endif; ?>
<?php if($is_client && $branch_info->status==38 && strlen($branch_info->evaluation_comment) >= 1) : ?>
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalLong2">
  * Deferred Reason/s
</button>
      ...
      <div class="card-body">
        ...
        <?php if($is_client) : ?>
          ...
          <p class="text-muted">
            ...
            <?php if($branch_info->status==30) echo "LETTER SUBMISSION SUCCESSFUL"; ?>
            <?php if($branch_info->status==33 && $branch_info->sent_lapse_notif == 0) echo "LETTER RECEIVED"; ?>
            <?php if($branch_info->status==33 && $branch_info->sent_lapse_notif == 1) echo "FOR UPLOADING"; ?>
            <?php if($branch_info->status==34) echo "FOR UPLOADING"; ?>
            <?php if($branch_info->status==35) echo "FOR EVALUATION"; ?>
            <?php if($branch_info->status==36) echo "FOR EVALUATION"; ?>
            <?php if($branch_info->status==37) echo "APPROVED APPLICATION FOR CLOSURE"; ?>
            <?php if($branch_info->status==38) echo "DEFERRED"; ?>
            <?php if($branch_info->status==39) echo "FOR PRINTING OF ORDER OF CLOSURE"; ?>
            <?php if($branch_info->status==29) echo "ISSUED ORDER OF CLOSURE"; ?>
    ...
    <div class="col-sm-12 col-md-8">
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($branch_info->status!= 0): ?>
            <small class="text-muted">
              <a href="<?php echo base_url();?>branches/<?= $encrypted_id ?>/documents_closure" class="btn btn-info btn-sm">View</a>
            </small>
          <?php endif;?>
        </li>
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($branch_info->status == 21 || $branch_info->status == 81) && $document_43): ?>
              <?php if($branch_info->reason != ''): ?>
                <small class="text-muted">
                  <a href="<?php echo base_url();?>bns_closure/<?= $encrypted_id ?>/evaluate" class="btn btn-color-blue btnFinalize btn-sm ">Submit</a>
                </small>
              <?php else : ?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            <div class="d-flex w-100 justify-content-between">
              ...
              <small class="text-muted">
                <?php if($document_44 && $document_45 && $document_44) :?>
                <span class="badge badge-success">COMPLETE</span>
                <?php endif; ?>
                <?php if(!$document_44 && !$document_45 && !$document_44) :?>
                <span class="badge badge-secondary">PENDING</span>
          ...
          <li class="list-group-item  flex-column align-items-start">
            <div class="d-flex w-100 justify-content-between">
              ...
              <small class="text-muted">
                <?php if($branch_info->status == 19 || $branch_info->status == 20 || $branch_info->status == 21 || $branch_info->status == 81) :?>
                <span class="badge badge-success">COMPLETE</span>
                <?php endif; ?>
