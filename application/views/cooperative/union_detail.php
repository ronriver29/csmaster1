      ...
      <div class="card-body">
        ...
        <p class="text-muted">
            <?php if($coop_info->grouping == 'Union') {?>
                <?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';} ?> 
            <?php } else { ?>
  ...
  <div class="col-sm-12 col-md-8">
    <ul class="list-group">
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $grouping && $coop_info->capital_contribution == $cc_count->total_cc): ?>
        <small class="text-muted">
     ...
     <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $grouping && $purposes_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
        <small class="text-muted">
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
        <small class="text-muted">
      ...
      <li class="list-group-item  flex-column align-items-start">
        <div class="d-flex w-100 justify-content-between">
          ...
          <small class="text-muted">
              <?php if($document_one && $document_two && $document_three && $document_four): ?>
              <span class="badge badge-success">COMPLETE</span>
            <?php endif;?>
            <?php if(!$document_one && !$document_two && !$document_three && !$document_four): ?>
            <span class="badge badge-secondary">PENDING</span>
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
          <small class="text-muted">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if(($coop_info->status==3 || $coop_info->status==6) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_four && $coop_info->capital_contribution == $cc_count->total_cc): ?>
          <small class="text-muted">
    ...
    <div class="col-sm-12 col-md-8">
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $article_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/committees" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <!-- <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
            <?php // if($count == 0) {?>
            <?php // } else {?>
                <small class="text-muted">
                  <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/survey" class="btn btn-info btn-sm">View</a>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $article_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/staff" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          <div class="d-flex w-100 justify-content-between">
            ...
            <small class="text-muted">
                <?php ;
                if($document_one && $document_two && $document_three && $document_four && $document_completed): ?>
                    <span class="badge badge-success">COMPLETE</span>
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $article_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
            <small class="text-muted">
              <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/documents" class="btn btn-info btn-sm">View</a>
            </small>
          <?php endif ?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_four && $document_completed && $article_complete && $coop_info->capital_contribution == $cc_count->total_cc): ?>
            <small class="text-muted">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status==16) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_four && $coop_info->capital_contribution == $cc_count->total_cc): ?>
              <small class="text-muted">
            ...
            <?php endif ?>
             <!-- donwload payment form -->
              <?php
              if(($coop_info->status ==13) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_four && $coop_info->capital_contribution == $cc_count->total_cc)
              {
                if ($pay_from=='reservation'){
                  ...
                  $lrf=(($rf)*.01>10) ?($rf)*.01 : 10;
                    ...
                    if($coop_info->grouping == 'Union'){
                        $payorname = ucwords($coop_info->proposed_name.' '.$coop_info->grouping.' Cooperative '.$acronym_name);
                    } else {
