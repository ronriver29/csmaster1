      ...
      <div class="card-body">
        ...
        <p class="text-muted">
            <?php if($coop_info->grouping == 'Union') {?>
                <?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';} echo ' '.$coop_info->grouping ?>
            <?php } else { ?>
  ...
  <div class="col-sm-12 col-md-8">
    <ul class="list-group">
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete): ?>
        <small class="text-muted">
      ...
      <li class="list-group-item  flex-column align-items-start">
        <div class="d-flex w-100 justify-content-between">
          ...
          <small class="text-muted">
              <?php if($document_one && $document_two && $document_three): ?>
              <span class="badge badge-success">COMPLETE</span>
            <?php endif;?>
            <?php if(!$document_one && !$document_two && !$document_three): ?>
            <span class="badge badge-secondary">PENDING</span>
        ...
        <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete): ?>
          <small class="text-muted">
    ...
    <div class="col-sm-12 col-md-8">
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $grouping): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/committees" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          <div class="d-flex w-100 justify-content-between">
            ...
            <small class="text-muted">
                <?php ;
                if($document_one && $document_two && $document_three && $document_completed): ?>
                    <span class="badge badge-success">COMPLETE</span>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_completed): ?>
            <small class="text-muted">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status==16) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three): ?>
              <small class="text-muted">
            ...
            <?php endif ?>
             <!-- donwload payment form -->
              <?php
              if(($coop_info->status ==13) && $bylaw_complete && $purposes_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three)
              {
