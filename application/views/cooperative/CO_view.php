...
<table width=100% style="background-image: url(<?=base_url();?>/assets/img/cda4.png); background-repeat: no-repeat; background-position: center;opacity: 0.2;">
	...
	<tr>
		<td style="text-align: center; font-size: 18pt;line-height: 25px;"><b><?= $branch_info->coopName?></b></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="text-align: justify; text-indent: 40px;">Given in Quezon City, Philippines, this <b><?=date("F d, Y", strtotime($branch_info->ok_for_conversion)); ?></b>.</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
