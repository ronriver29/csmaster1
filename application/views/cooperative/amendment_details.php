        ...
        <li class="list-group-item  flex-column align-items-start">
          <div class="d-flex w-100 justify-content-between">
            ...
            <?php if(count( $count_coop_type)>1){?>
                ...
                <span class="badge badge-secondary">PENDING</span>
                <?php endif;?> -->
                <?php if($status_document_cooptype && $status_feasibility && $status_books_of_account): ?>
                <span class="badge badge-success">COMPLETE</span>
                <?php else: ?>
                <span class="badge badge-secondary">PENDING</span>
                <?php endif;?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(count( $count_coop_type)>1):?>
              <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $cooperator_complete && $committees_complete && $status_document_cooptype && $status_feasibility && $status_books_of_account && $complete_position){ ?>
              <small class="text-muted">
            ...
            <?php else: ?> 
                <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $cooperator_complete && $committees_complete && $status_document_cooptype && $complete_position){ ?>
                  <small class="text-muted">
                    <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/evaluate" class="btn btn-color-blue btnFinalize btn-sm ">Submit</a>
                  </small>
