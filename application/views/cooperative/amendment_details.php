    ...
    <ul class="list-group">
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status==3 && $bylaw_complete && $purposes_complete && $article_complete && $cooperator_complete && $economic_survey_complete && $staff_complete && $document_one && $document_two): ?>
          <small class="text-muted">
    ...
    <div class="col-sm-12 col-md-8">
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete  ): // Comment insert later This () ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/amendment_purposes" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete): // Comment this && $cooperator_complete?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/amendment_articles" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete ): //Comment this && $cooperator_complete?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/committees" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete ): //Comment this && $cooperator_complete && $committees_complete?>
            <?php if($count == 0) {?>
            <?php } else {?>
                <small class="text-muted">
                  <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/amendment_survey" class="btn btn-info btn-sm">View</a>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete ): // comment this && $cooperator_complete && $committees_complete && $economic_survey_complete?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>amendment/<?= $encrypted_id ?>/amendment_staff" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
