...
<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_id ?>/bns_transfer" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('payments_branch_for_transfer/add_payment',array('id'=>'paymentForm','name'=>'paymentForm')); ?>
        ...
        <div class="row">
          <table class="bord" width="65%">
            ...
            <tr>
              ...
              <td class="bord" colspan="3"><b>Transfer</b></td>
            </tr>
            <tr>
