        ...
        <?php endif;  ?>
          <div class="col-sm-12 col-md-12">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="form-group">
                  <label for="regNp">Registration No:</label>
                ...
                <div class="row-cis">
                  <div class="col-sm-12 col-md-12">
                    <div class="form-group">
                      ...
                      <select class="custom-select form-control  validate[required]" name="majorIndustry[]" id="majoreIndustry1" readonly="readonly" required="">
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-12">
                    <div class="form-group">
                      ...
                      <select class="custom-select form-control validate[required]" name="subClass[]" id="subClass1" readonly="readonly" required="">
                      </select>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12">
                <div class="form-group">
                  ...
                  data-html="true" title="<li>Don't include the type of your cooperative in your new name.</li><li>Don't include the word <b>cooperative</b>.</li>"></i> New Name of the Cooperative:</label>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-com">
                <div class="form-group">
                  ...
                  <select class="custom-select validate[required]" name="compositionOfMembers[]" id="compositionOfMembers1">
                    <option value="" selected></option>
                    <?php
          ...
          <div class="col-sm-12 col-md-12">
            <div class="row">
              <div class="col-sm-12 col-md-12">
                <div class="form-group">
                  <strong>New Address of the Cooperative</strong>
                </div>
              </div>
