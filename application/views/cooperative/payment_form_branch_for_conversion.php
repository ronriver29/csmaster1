...
<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>branches/<?= $encrypted_id ?>/bns_conversion" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('payments_branch_for_conversion/add_payment',array('id'=>'paymentForm','name'=>'paymentForm')); ?>
        ...
        <div class="row">
          <table class="bord" width="65%">
            ...
            ?>
              ...
              $report_exist = $this->db->where(array('bns_id'=>ucwords($branch_info->id),'nature'=>$bns_type))->get('payment');
            ...
            <tr>
              ...
              <td class="bord" colspan="3"><b>Conversion</b></td>
            </tr>
            <tr>
          ...
          <input type="hidden" class="form-control" id="nature" name="nature" value="<?=$bns_type?>">
