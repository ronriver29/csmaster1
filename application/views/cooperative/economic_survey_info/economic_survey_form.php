...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('cooperatives/'.$encrypted_id.'/survey',array('id'=>'economicSurveyForm','name'=>'economicSurveyForm')); ?>
      ...
      <div class="card-body">
        ...
        <div class="row mb-2 row-pre-reg">
            ...
            <div class="form-check">
              <input type="checkbox" class="form-check-input" value="1" name="previouslyRegisteredWith" id="registeredSec" disabled <?php if($survey_info->previously_registered_with == 1) echo "checked"; ?> >
              <label class="form-check-label" for="registeredSec">SEC</label>
            </div>
          </div>
          <div class="col-sm-12 col-md-2">
            <div class="form-check">
              <input type="checkbox" class="form-check-input " value="2" name="previouslyRegisteredWith_dole" id="registeredDole" disabled <?php if($survey_info->previously_registered_with_dole == 2) echo "checked"; ?> >
              <label class="form-check-label" for="registeredDole">DOLE</label>
               ...
               <div class="col-sm-12 col-md-2">
            <div class="form-check">
              <input type="checkbox" class="form-check-input " value="4" name="previously_registered_with_none" id="registeredDole" disabled <?php if($survey_info->previously_registered_with_none == 4) echo "checked"; ?> >
        ...
        <div class="col-sm-12 col-md-3">
            <div class="form-check">
              <input type="checkbox" class="form-check-input" value="3" name="previouslyRegisteredWith_other" id="registeredOthers" disabled <?php if(strlen($survey_info->previously_registered_with_others)> 0)  echo "checked"; ?> >
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control validate[required,custom[integer],min[1]]" id="initialCapital" name="initialCapital" min="1"  value="<?= $InitialCapital?>" readonly >
              </div>
          </div>
          <div class="col-sm-12 col-md-12">
              <div class="form-group">
