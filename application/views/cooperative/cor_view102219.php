...
<body>
	...
	<div style="height: 1160px;border: 10px black double; border-radius: 30px;padding:20px;">
	<table width="100%">
		<tr>
...
<table width=100% style="background-image: url(<?=base_url();?>/assets/img/cda3.png); background-repeat: no-repeat; background-position: center;margin-top:-30px;padding-bottom: 60px;">
	...
	<tr>
		<td style="padding-left:45px;"><img src="<?=base_url();?>/assets/qr_code/tmp/qr_codes_images/<?= $coop_info->regNo ?>.png" width="100" height="100" ></td>
	...
	<tr>
		<td  colspan="2" style="text-align: justify; text-indent: 40px;">Given in Quezon City, Philippines, this <?=date("F d, Y", strtotime( (substr($coop_info->dateRegistered,3,2).'-'.substr($coop_info->dateRegistered,0,2).'-'.substr($coop_info->dateRegistered,6,4) ) ) ); ?>.</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
...
<div class="page_break" style="border: 10px black double;height: 1160px; border-radius: 30px; padding: 20px">
...
<table width=100% style="background-image: url(<?=base_url();?>/assets/img/cda3.png); background-repeat: no-repeat; background-position: center;">
	...
	<tr>
		<td>
			<img src="<?=base_url();?>/assets/qr_code/tmp/qr_codes_images/<?= $coop_info->regNo ?>.png" width="100" height="100" >
		</td>
		<td><i style="color:white; font-size: 8pt">....</i></td>
	</tr>
	<tr>
		<td style="color: white; background-color: #0000FF; text-align: center; font-size: 20pt">CERTIFICATE OF REGISTRATION</td>
	</tr>
	<tr>
		<td><i style="color:white; font-size: 8pt">....</i></td>
	</tr>
	...
	<tr>
		<td style="text-align: justify; text-indent: 40px;">This is to certify that</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
	<tr>
		<td style="text-align: center; font-size: 20pt;"><b><?= $coop_info->coopName?></b></td>
	</tr>
	<tr>
		<td style="text-align: center; font-size: 9pt;">Name of Cooperative</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
	<tr>
		<td style="text-align: justify;">with address at <b><?= ucwords($coop_info->noStreet)?> <?= ucwords($coop_info->Street).$x?> <?= $coop_info->brgy?>, <?= $coop_info->city?>, <?= $coop_info->province?></b>, has presented and filed with the Authority its Articles of Cooperation and By-laws duly signed and acknowledged for its organization in accordance with the provisions of Republic Act 9520. This certifies further that the said Articles of Cooperation and By-laws have complied with the provisions of the said Republic Act 9520 and its Implementing Rules and Regulations.</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
	<tr>
		<td style="text-align: justify; ; text-indent: 40px;">By virtue of the powers and duties vested upon me by law, the above named cooperative is hereby registered with the Cooperative Development Authority and shall continue to enjoy the rights and privileges in accordance with Republic Act 9520 and all other laws appurtenant thereto unless this Certificate is suspended or cancelled for cause.</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
	<tr>
		<td style="text-align: justify; text-indent: 40px;">Given in Quezon City, Philippines, this <?=date("F d, Y", strtotime( (substr($coop_info->dateRegistered,3,2).'-'.substr($coop_info->dateRegistered,0,2).'-'.substr($coop_info->dateRegistered,6,4) ) ) ); ?>.</td>
	</tr>
	<tr>
		<td><i style="color:white;">....</i></td>
	</tr>
...
<div class="page_break" style="text-align: justify; font-family: Calibri,sans-serif; font-size: 12.5px; background-image: url(<?=base_url();?>/assets/img/cda2.png); background-repeat: no-repeat; background-position: center;">
<p >
