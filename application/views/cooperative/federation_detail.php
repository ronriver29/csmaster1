      ...
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three && $document_completed): ?>
            <small class="text-muted">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status==16) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $staff_complete && $document_one && $document_two && $document_three): ?>
              <small class="text-muted">
            ...
            <?php endif ?>
             <!-- donwload payment form -->
              <?php
              if(($coop_info->status ==13) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $economic_survey_complete && $staff_complete && $document_one && $document_two && $document_three)
              {
