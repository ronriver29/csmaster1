    ...
    <div class="card border-top-blue shadow-sm mb-4">
      ...
      <div class="card-body">
        ...
        <p class="text-muted">
            ...
            <?php if($coop_info->grouping == 'Union' && $coop_info->type_of_cooperative != 'Technology Service') {?>
            ...
            <?php } else { ?>
                ...
                <?= $coop_info->proposed_name?> Federation of <?= $coop_info->type_of_cooperative?> Cooperative <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?>
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <div class="d-flex w-100 justify-content-between">
          ...
          <small class="text-muted">
              ...
              <?php if($document_two && $document_three && $document_four): ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if(($coop_info->status==3 || $coop_info->status==6) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $staff_complete && $document_two && $document_three && $document_four): ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <div class="d-flex w-100 justify-content-between">
            ...
            <small class="text-muted">
              ...
              } elseif($coop_info->grouping == 'Union'){
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <div class="d-flex w-100 justify-content-between">
            ...
            <small class="text-muted">
                ...
                if($document_two && $document_three && $document_four && $document_completed): ?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $staff_complete && $document_two && $document_three && $document_four && $document_completed): ?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status==16) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $staff_complete && $document_two && $document_three && $document_four): ?>
