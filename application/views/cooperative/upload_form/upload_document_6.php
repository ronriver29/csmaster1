<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    ...
    <h5 class="text-primary text-right">Upload G.A. Resolution</h5>
  </div>
</div>
<div class="row">
  <div class="col-sm-12 col-md-12">
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open_multipart('documents/do_upload_6',array('id'=>'uploadOtherDocumentForm','name'=>'uploadOtherDocumentForm')); ?>
      <div class="card-body">
        <div class="row ac-row">
          ...
          <div class="col-sm-12 col-md-12">
            <div class="form-group">
              <input type="file" class="form-control validate[required]" name="file6" id="file6" accept="application/pdf">
            </div>
          </div>
        </div>
      </div>
