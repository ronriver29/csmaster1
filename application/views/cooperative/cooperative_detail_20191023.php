        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <small class="text-muted">
            <div class="btn-group" role="group" aria-label="Basic example">
              ...
              <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#approveCooperativeModal"  data-cname="<?= $coop_info->proposed_name?> <?=$coop_info->type_of_cooperative?>" data-coopid="<?= encrypt_custom($this->encryption->encrypt($coop_info->id))?>" <?php if($coop_info->tool_yn_answer==null) echo 'disabled';?> >Submit</button>
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item  flex-column align-items-start">
          <div class="d-flex w-100 justify-content-between">
            ...
            <small class="text-muted">
              <?php if($list_cooperators_count > 14): ?>
                <span class="badge badge-success">COMPLETE</span>
              <?php endif; ?>
              <?php if($list_cooperators_count < 15): ?>
                <span class="badge badge-secondary">PENDING</span>
              <?php endif; ?>
            </small>
          </div>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $cooperator_complete && $list_cooperators_count > 14): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/purposes" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $list_cooperators_count > 14 && $purposes_complete): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/articles" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/committees" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14 && $gad_count != 0): ?>
            <?php if($count == 0) {?>
            <?php } else {?>
                <small class="text-muted">
                  <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/survey" class="btn btn-info btn-sm">View</a>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14 && $gad_count != 0 && $economic_survey_complete): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/staff" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif ?>
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if($coop_info->status!= 0 && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14 && $gad_count != 0 && $economic_survey_complete && $staff_complete): ?>
            <small class="text-muted">
              <a href="<?php echo base_url();?>cooperatives/<?= $encrypted_id ?>/documents" class="btn btn-info btn-sm">View</a>
            </small>
          <?php endif ?>
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14 && $gad_count != 0 && $economic_survey_complete && $staff_complete && $document_one && $document_two): ?>
            <small class="text-muted">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php if(($coop_info->status==16) && $bylaw_complete && $purposes_complete && $article_complete && $list_cooperators_count > 14 && $gad_count != 0 && $economic_survey_complete && $staff_complete && $document_one && $document_two): ?>
              <small class="text-muted">
