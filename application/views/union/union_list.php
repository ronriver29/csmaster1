                ...
                <?php if(!$requirements_complete || $coop_info->capital_contribution != $cc_count->total_cc): ?>
                  <b>Note:</b>
                   <ul>
                      ...
                      <?php if($coop_info->capital_contribution != $cc_count->total_cc && $coop_info->capital_contribution != 0) echo '<li>Dues and Contribution must be equal to '.$coop_info->capital_contribution.'. (Current Total Paid Shares: <b>'.$cc_count->total_cc.'</b>)</li>';?>
