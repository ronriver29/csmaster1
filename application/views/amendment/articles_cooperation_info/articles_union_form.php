...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment/'.$encrypted_id.'/article_union',array('id'=>'articlesUnionForm','name'=>'articlesUnionForm')); ?>
      <div class="card-header">
        <div class="row">
          <div class="col-sm-12 col-md-4">
            <h5>Articles of Cooperation - Union Information:</h5>
          </div>
