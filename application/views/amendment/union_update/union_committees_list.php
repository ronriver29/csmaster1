              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                    ...
                    <?php if($committee['name'] != 'Audit' && $committee['name'] != 'Education and Training' && $committee['name'] != 'Election' && $committee['name'] != 'Ethics' && $committee['name'] != 'Gender and Development' && $committee['name'] != 'Mediation and Conciliation' && $committee['name'] != 'Credit'){?>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteCommitteeModal" data-comname="<?= $committee['name'] ?>" data-fname="<?=$committee['name']?>" data-coopid="<?= $encrypted_id ?>" data-committeeid="<?= encrypt_custom($this->encryption->encrypt($committee['comid']))?>"><i class='fas fa-trash'></i> Delete</button>
                    <?php } ?>
                  </div>
                </td>
                <?php endif;?>
