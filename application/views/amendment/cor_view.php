...
<br/><br/>
	...
	<table width=100%  style="background: url(<?=base_url();?>/assets/img/cda4.png); background-repeat: no-repeat; background-position: center;margin-top:-30px;padding-bottom: 60px;opacity: 0.2;">
	    ...
	    <tr>
			...
			<td style="text-align: justify; text-indent: 40px;">The attached amended <?php if($acbl['articles']){echo'Articles of Cooperation consisting of '; if(isset($articles_pages)){echo'<b>'.$articles_pages->total_pages.'</b> pages';}else{echo'<small style="color:red">Please generate articles of cooperation document to get the total number pages</small>';}}?><?=$and2?><?php if($acbl['bylaws']){echo'By Laws consisting of ';if(isset($bylaws_pages->total_pages)){echo'<b>'.$bylaws_pages->total_pages.'</b> pages';}else{echo'<small style="color:red">Please generate bylaws document to get the total number of pages</small>';}}?>, being not contrary
	...
	<table width="100%" style="margin-top:-50px;">
		...
		<tr>
			...
			<img src="<?=APPPATH.$signature?>" style="width:270px;height:100px;padding-left:140px;padding-buttom:100px;">
...
<br/><br/>
	...
	<table width=100%  style="background: url(<?=base_url();?>/assets/img/cda4.png); background-repeat: no-repeat; background-position: center;margin-top:-30px;padding-bottom: 60px;opacity: 0.2;">
	    ...
	    <tr>
			...
			<td style="text-align: justify; text-indent: 40px;">The attached amended <?php if($acbl['articles']){echo'Articles of Cooperation consisting of '; if(isset($articles_pages)){echo'<b>'.$articles_pages->total_pages.'</b> pages';}else{echo'<small style="color:red">Please generate articles of cooperation document to get the total number of pages</small>';}}?><?=$and2?><?php if($acbl['bylaws']){echo'By Laws consisting of ';if(isset($bylaws_pages->total_pages)){echo'<b>'.$bylaws_pages->total_pages.'</b> pages';}else{echo'<small style="color:red">Please generate bylaws document to get the total number of  pages</small>';}}?>, being not contrary
