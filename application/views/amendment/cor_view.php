...
<br/><br/>
	<table width=100%  style="background: url(<?=base_url();?>/assets/img/cda4.png); background-repeat: no-repeat; background-position: center;margin-top:-30px;padding-bottom: 60px;opacity: 0.2;">
		...
		<tr>
	            <td style="color: white; background-color: #003399; text-align: center; font-size: 15pt">CERTIFICATE OF REGISTRATION<br>OF<br>AMENDMENTS TO THE<br>
	            	<?php if($articles){?><b>ARTICLES OF COOPERATION</b><?php }?><?=$and;?><?php if($bylaws){?><b>BY LAWS</b><?php }?></td>
		</tr>
		<tr>
			<td><i style="color:white; font-size: 8pt">....</i></td>
		</tr>
