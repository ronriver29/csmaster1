...
<br/><br/>
	<table width=100% style="background-image: url(<?=base_url();?>/assets/img/cda3.png); background-repeat: no-repeat; background-position: center;">
		...
		<tr>
	        ...
	        <tr>
			<td style="text-align: justify; text-indent: 40px;">The attached amended Articles of Cooperation consisting of <b><?=$this->session->userdata('pagecount')?></b> pages and By-Laws consisting of <b>22</b> pages, being not contrary
