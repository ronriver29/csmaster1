...
<div class="row">
  ...
  <div class="col-sm-12 col-md-12">
    ...
    <div class="card border-top-blue mb-4">
      ...
      <?php echo form_open_multipart('amendment_documents/do_upload_acbl',array('id'=>'uploadOtherDocumentForm','name'=>'uploadOtherDocumentForm')); ?>

      <div class="card-body">

        <div class="row ac-row">

          <input type="hidden" class="form-control" id="amendment_id" name="amendment_id" value="<?=$encrypted_id ?>" readonly>

          <input type="hidden" class="form-control" id="document_num" name="document_num" value="<?=$encrypted_doc_num?>" readonly>
