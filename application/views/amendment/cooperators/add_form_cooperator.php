...
<div class="row">
  <div class="col-sm-12 col-md-12">
    ...
    <?php echo form_open('amendment_update/'.$encrypted_id.'/amendment_cooperator/add',array('id'=>'addCooperatorFormAmendment','name'=>'addCooperatorFormAmendment')); ?>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              ...
              <input type="number"  class="form-control validate[required]" id="amd_subscribedShares" name="subscribedShares" readonly>
          ...
          <div class="col-sm-12 col-md-3">
            <div class="form-group">
              ...
              <input type="number"  class="form-control validate[required]" id="amd_paidShares" name="paidShares" readonly>
            ...
            <?php //if($coop_info->area_of_operation == 'Barangay'){ ?>
              <div class="col-sm-12 col-md-4">
                <div class="form-group">
                  ...
                  <select class="custom-select validate[required]" id="barangay" >
                       <?php
