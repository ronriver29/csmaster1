...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment/'.$encrypted_id.'/bylaws_primary',array('id'=>'bylawsPrimaryForm','name'=>'bylawsPrimaryForm')); ?>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control " style="resize: none;" id="additionalRequirementsForMembership" name="additionalRequirementsForMembership" placeholder="Ex. &#10;item 1;&#10;item2;&#10;itemlast."rows="8" disabled><?= $bylaw_info->additional_requirements_for_membership ?></textarea>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            ...
            <input type="number" value="<?= $bylaw_info->act_upon_membership_days ?>" class="form-control validate[required,min[15],max[30],custom[integer]]" id="actUponMembershipDays" name="actUponMembershipDays" min="15" placeholder="Enter Days" disabled>
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <input type="text" value="<?= number_format($bylaw_info->membership_fee,2) ?>" min="0" step="any" class="form-control validate[required,min[0],custom[number]]" id="membershipFee" name="membershipFee"placeholder="&#8369; 0.00" disabled>
          ...
          <div class="row row-subscriptions">
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
          			...
          			<input type="number" value="<?= $bylaw_info->regular_percentage_shares_subscription ?>" class="form-control validate[required,min[1],custom[integer]]" id="regularMembershipPercentageSubscription" name="regularMembershipPercentageSubscription" placeholder="Enter Shares" disabled>
          		</div>
              <div class="form-group">
                <label for="regularMembershipPercentagePay">What is the minimum number of shares that the applicant must pay upon approval of regular membership?</label>
          			<input type="number" value="<?= $bylaw_info->regular_percentage_shares_pay ?>" class="form-control validate[required,min[1],custom[integer],funcCall[validateMinimumPaidRegularPrimaryCustom]]" id="regularMembershipPercentagePay" name="regularMembershipPercentagePay" placeholder="Enter Shares" disabled>
              </div>
        		</div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control " style="resize: none;" id="additionalConditionsForVoting" name="additionalConditionsForVoting" placeholder="Ex. &#10;item 1;&#10;item2;&#10;itemlast."rows="8" disabled><?= $bylaw_info->additional_conditions_to_vote ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    <label for="regularMeetingDay"><strong>Date</strong></small></label>
                    <input type="date" value="<?=$bylaw_info->annual_regular_meeting_day_date?>" class="form-control validate[required]" id="regularMeetingDay" name="regularMeetingDayDate" disabled>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    <label for="regularMeetingDay"><strong>Venue</strong></small></label>
                    <input type="text" value="<?=$bylaw_info->annual_regular_meeting_day_venue?>" class="form-control validate[required]" id="regularMeetingDay" name="regularMeetingDayVenue" disabled>
                </div>
            </div>
        </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="quorumPercentage"><strong>How many percent of the members are entitled to vote to constitute the quorum?</strong> <small  class="text-info">Atleast twenty five percent.</small></label>
        			<input type="number" value="<?=$bylaw_info->members_percent_quorom?>"  class="form-control validate[required,min[25],max[100],custom[integer]]" id="quorumPercentage" name="quorumPercentage" min="25" max="100" placeholder="Enter Percent %" value="25" disabled>
        		 </div>
        		</div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="form-group">
                 ...
                 <input type="number" value="<?=$bylaw_info->number_of_absences_disqualification?>" class="form-control validate[required,min[2],custom[integer]]" id="consecutiveAbsences" name="consecutiveAbsences" min="2" placeholder="Enter Number" disabled>
              </div>
               <div class="form-group">
                 ...
                 <input type="number" value="<?=$bylaw_info->percent_of_absences_all_meettings?>" class="form-control validate[required,min[25],max[100],custom[integer]]" id="consecutivePercentageAbsences" name="consecutivePercentageAbsences" min="25" max="100" placeholder="Enter Percent %" disabled>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="investPerMonth"><strong>At least how much a member should invest monthly?</strong></label>
        			 <input type="text" value="<?=number_format($bylaw_info->member_invest_per_month,2)?>" class="form-control validate[required,min[1],custom[number]]" min="1" id="investPerMonth" name="investPerMonth" placeholder="" disabled>
        		 </div>
        		</div>
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="investAnnualInterest"><strong>Percentage of every member’s annual interest on share capital and patronage refund should be invested?</strong></label>
        			 <input type="number" value="<?=$bylaw_info->member_percentage_annual_interest?>" class="form-control validate[required,min[1],max[100],custom[integer]]" min="1" max="100" id="investAnnualInterest" name="investAnnualInterest" placeholder="%" disabled>
        		 </div>
        		</div>
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="investService"><strong>Percentage of goods procured/services availed by every member should be invested?</strong></label>
        			 <input type="number" value="<?=$bylaw_info->member_percentage_service?>" class="form-control validate[required,min[1],max[100],custom[integer]]" min="1" max="100" id="investService" name="investService" placeholder="%" disabled>
        		 </div>
        		</div>
          </div>
          <div class="row">
        		...
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="communityFund"><strong>Percentage to be set aside for Community Development Fund?</strong></label>
        			 <input type="number" value="<?=$bylaw_info->percent_community_fund?>" class="form-control validate[required,min[3],max[100],custom[integer]]" min="3" max="100" id="communityFund" name="communityFund" placeholder="%" disabled>
        		 </div>
        		</div>
        		<div class="col-sm-12 col-md-12">
        		  <div class="form-group">
        			<label for="othersFund"><strong>Percentage to be set aside for Optional Fund?</strong></label>
        			 <input type="number" value="<?=$bylaw_info->percent_optional_fund?>" class="form-control validate[required,min[0],max[7],custom[integer]" min="0" max="7" id="othersFund" name="othersFund" placeholder="%" disabled>
        		 </div>
        		</div>
          </div>
          <div class="row">
