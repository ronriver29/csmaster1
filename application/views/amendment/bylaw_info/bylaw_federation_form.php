...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment/'.$encrypted_id.'/bylaws_federation',array('id'=>'bylawsPrimaryForm','name'=>'bylawsPrimaryForm')); ?>
      ...
      <div class="card-body">
        ...
        <div class="row additionalRequirementsForMembership">
          <div class="col-sm-12 col-md-12">
            ...
            <?php
            foreach($add_membership as $additional_req_membership_reg)
            {
            ?>
              <textarea class="form-control " style="resize: none;" id="additionalRequirementsForMembership" name="additionalRequirementsForMembership[]" placeholder="Must be in a sentence" rows="8" value="<?= $additional_req_membership_reg ?>" disabled></textarea>
            <?php
            }
             ?>
