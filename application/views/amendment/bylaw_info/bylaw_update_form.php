...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment_update/'.$encrypted_id.'/bylaw_update_primary',array('id'=>'bylawsPrimaryForm','name'=>'bylawsPrimaryForm')); ?>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <input type="text" value="<?= number_format($bylaw_info->membership_fee,2) ?>"  step="any" class="form-control v" id="membershipFee" name="membershipFee"   placeholder="&#8369; 0.00" disabled>
...
<!--                                <select class="form-control validate[required]" id="regularMeetingDay" name="regularMeetingDay" placeholder="ex. second/2nd saturday of february" disabled>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="form-group">
                      ...
                      <select value="<?=$bylaw_info->members_percent_quorom?>" class="form-control " nid="quorumPercentage" name="quorumPercentage" disabled>
                      <?php 
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              ...
              <label for="investPerMonth"><strong>At least how much a member should invest monthly?</strong></label>
               <input type="text" value="<?=$bylaw_info->member_invest_per_month?>" class="form-control  id="investPerMonth" name="investPerMonth" placeholder="" disabled>
             </div>
            </div>
            <div class="col-sm-12 col-md-12">
              <div class="form-group">
              ...
              <div class="modal-content">
                <?php //echo form_open('bylaws/primary',array('id'=>'deleteAlertForm','name'=>'deleteAlertForm')); ?>
                  ...
                  <div class="modal-footer deleteAlertFooter">
                    <input class="btn btn-color-blue btn-block" type="submit" id="bylawsPrimaryBtn2" name="bylawsPrimaryBtn" value="Submit">
                  </div>
                <!-- </form> -->
              </div>
            </div>
     ...
     <!--  <button type="button" class="btn btn-color-blue btn-block" data-toggle="modal" data-target="#deleteAlertModal" name="bylawsPrimaryBtn" id="bylawsPrimaryBtn2"></i>Submit</button> -->
         <input class="btn btn-color-blue btn-block" type="submit" id="bylawsPrimaryBtn" name="submit" value="Submit">
      </div>
