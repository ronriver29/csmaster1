...
<?php
    ...
    $total_members = (strlen($regular_members) > 0 ? $regular_members : 0);//+ (strlen($associate_members)>0 ? $associate_members : 0)) : "";

?>
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment/'.$encrypted_id.'/amendment_capitalization',array('id'=>'capitalizationForm','name'=>'capitalizationForm')); ?>
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Regular</td>
                        <td>
                            <input type="number" name="item[regular_members]" id="regular_members" class="form-control" min="5" value="<?=$regular_members;?>"/>
                            <br/>
...
function computeCapital() {
    ...
    if($("#regular_members").length>0) {
        ...
        if(regular_members < 5) {
            $("#regular_members_note").html("Should be at least 5 members");
