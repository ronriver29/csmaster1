    ...
    <div class="card border-top-blue mb-4">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <table class="bord" width="65%">
            ...
            <?php 
              ...
              $name_comparison = strcasecmp($orig_proposedName_formated,$proposeName);
                ...
                <td><p style="font-style:italic;font-size:11pt;">(1/10 of 1% of Php '.number_format($diff_amount,2).' '.$desc.'<br> amounted to Php '.number_format($percentage_amount,2).' plus Php 300.00 basic fee)<p></td>
          ...
          <input type="hidden" class="form-control" id="regNo" name="regNo" value="<?=$coop_info->regNo?>">
          <input type="hidden" class="form-control" id="ref_no" name="ref_no" value="<?=$ref_no?>">
          <input type="hidden" class="form-control" id ="applicant" name="applicant" value="<?=$client_info->first_name.' '.$client_info->last_name?>">
          <input type="hidden" class="form-control" id="reg_desc" name="regDesc" value="<?=$regInfo->regDesc?>">
          ...
          <input type="hidden" class="form-control" id="particulars" name="particulars" value="<b>Name Reservation Fee<br><br/>Amendment Fee</b> <br>(1/10 of 1% of Php <?=number_format($diff_amount,2)?> <?=$desc?><br> amounted to Php <?=number_format($percentage_amount,2)?> plus Php 300.00 basic fee)<br><br><b>Legal and Research Fund Fee<b>">
          ...
          <input type="hidden" class="form-control" id="particulars" name="particulars" value="<b>Amendment Fee<b> <br/>(1/10 of 1% of Php <?=number_format($diff_amount,2)?> <?=$desc?><br> amounted to Php <?=number_format($percentage_amount,2)?> plus Php 300.00 basic fee)<br><br><b>Legal and Research Fund Fee</b>">
