...
<?php endforeach; ?>
<?php } //end if ?>
<?php $array_access_level =array(1,2,3,4);?>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      ...
      <?php echo form_open('amendment_union/update_cc',array('id'=>'addAdministratorForm','name'=>'addAdministratorForm')); ?>
      <div class="card-body">
        <div class="row">
          ...
          <?php
            $array_status=array(1,11);
            if($is_client && in_array($coop_info->status,$array_status)):
          ?>
  ...
  <div class="col-sm-12 col-md-12">
    ...
    <div class="card border-top-blue">
      <div class="card-body">
        ...
        <?php echo form_open('amendment/'.$encrypted_id.'/amendment_union',array('id'=>'amendmentAddForm','name'=>'amendmentAddForm')); ?>
        ...
        <div class="row col-sm-6 col-md-1 align-self-center col-reserve-btn">
          <?php if($coop_info->capital_contribution >0){?>
...
<br>
<?php } //end if is client?>
<?php // if($coop_info->capital_contribution != $cc_count->total_cc){ ?>
<div class="row">
  <div class="col-sm-12 col-md-12">
    <h4 class="text-left" style="margin-left:1em;">
      Added Cooperatives
    </h4>
  </div>
  <div class="col-sm-12 col-md-12">
