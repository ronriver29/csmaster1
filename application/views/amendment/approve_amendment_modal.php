...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="modal fade" id="approveAmendmentModal" role="dialog">
      <div class="modal-dialog modal-xl" style="width:90% !important;max-width:1360px;">
        <div class="modal-content">
          <?php echo form_open('amendment_update/authorized_user_submission',array('id'=>'approveCooperativeForm','name'=>'approveCooperativeForm')); ?>
            <div class="modal-header">
