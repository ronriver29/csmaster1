<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>amendment_update/<?= $encrypted_id ?>/committees_update" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment_update/'.$encrypted_id.'/committees_update/add',array('id'=>'addCommitteeFormAmendmentupdate','name'=>'addCommitteeFormAmendment')); ?>
        ...
        <div class="row ac-row">  
          ...
          <!-- <div class="col-sm-12 col-md-4">
            <div class="form-group">
              ...
              <select class="custom-select  cooperator_id" name="cooperatorID" id="cooperator_ID">
