...
{
  $brgy = ' ,'.$coop_info->brgy;
  $province = ' ,'.$coop_info->province;
  $city = ' ,'.$coop_info->city;
  $region = ' '.$brgy = $coop_info->region;
}
?>
<div class="row mb-2">
  ...
  <div class="col-sm-12 col-md-4">
    <div class="card border-top-blue shadow-sm mb-4">
      ...
      <div class="card-body">
        ...
        <p class="text-muted"> <?=$coop_info->coopName?>
           <!--  <?php if($coop_info->grouping == 'Union' && $coop_info->type_of_cooperative == 'Union') {?>
            ...
            <?php } else { ?>
                <?= $coop_info->proposed_name?> <?= $coop_info->type_of_cooperative?> Cooperative <?php if(!empty($coop_info->acronym_name)){ echo '('.$coop_info->acronym_name.')';}?> Others
            <?php } ?> -->
        </p>
        <hr>
        <strong>Category of Cooperative</strong>
        <p class="text-muted">
          <?php if($coop_info->grouping == 'Union' || $coop_info->type_of_cooperative == 'Cooperative Bank' || $coop_info->type_of_cooperative == 'Insurance' || $coop_info->type_of_cooperative == 'Bank'){
            echo 'Others';
          } else {
            echo $coop_info->category_of_cooperative;
          }?>
        </p>
       <!--  <hr>
      ...
      <?php if(($is_client && ($coop_info->status==11||$coop_info->status<=1)) || (!$is_client &&  $coop_info->status==3) || (!$is_client &&  $coop_info->status==6) || (!$is_client)): ?>
        <div class="card-footer">
          <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/rupdate" class="btn btn-block btn-color-blue"><i class='fas fa-edit'></i> Update Basic Information</a>
        </div>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="col-sm-12 col-md-8">
    <ul class="list-group">
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/bylaws_union" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif;?>
      </li>
      ...
      <!-- <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0 && $coop_info->type_of_cooperative != 'Cooperative Bank' && $coop_info->type_of_cooperative != 'Insurance' && $coop_info->type_of_cooperative != 'Union' && $coop_info->grouping != 'Union'): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/capitalization_update" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif;?>
      </li> -->
          ...
          <?php
                if($coop_info->grouping == 'Federation'){
                    ...
                    $groupingname = 'Federation';
                        $stepfourdirectory = 'unioncoop_update';
                } else {
                    $groupingname = 'Cooperators';
                    $stepfourdirectory = 'cooperators_update';
                }
            ?>
        <?php if($coop_info->status!= 0 && $is_update_cooperative): ?>
        <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/<?=$stepfourdirectory?>" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0): ?>
        <small class="text-muted">
          <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/purposes_update" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0): ?>
        <small class="text-muted">
          <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/article_update/primary" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0): ?>
        <small class="text-muted">
          <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/committees_update" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <!-- <li class="list-group-item  flex-column align-items-start">
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <small class="text-muted">
          <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/staff_update" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <li class="list-group-item  flex-column align-items-start">
      ...
      <ul class="list-group">
        <li class="list-group-item  flex-column align-items-start">
          ...
          <p class="mb-1 font-italic">Cooperative Name Reservation and Basic Information.</p>
           <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/rupdate" class="btn btn-info btn-sm">View</a>
          </small>
        </li>
        <li class="list-group-item  flex-column align-items-start">
          <div class="d-flex w-100 justify-content-between">
        ...
        <!-- <li class="list-group-item  flex-column align-items-start">
          ...
          <?php if(($coop_info->status!= 0 && $coop_info->type_of_cooperative != 'Cooperative Bank' && $coop_info->type_of_cooperative != 'Insurance')): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/capitalization_update" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif;?>
