    ...
    <div class="modal fade" id="addAffiliatorModal" data-backdrop="static" data-hidden.bs.modal="this.form.reset();"tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl" style="width:90% !important;max-width:1360px;">
        <div class="modal-content">
          <?php echo form_open('affiliators_update/add_affiliators',array('id'=>'deleteCooperatorForm','name'=>'deleteCooperatorForm')); ?>
            ...
            <div class="modal-body">
              <input type="hidden" class="form-control" name="usersid" value="<?=$user_id?>">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-4">
                  <div class="form-group"> 
                    ...
                    <select class="form-control select2 select-island add-affiliators" id="position" name="position[]" multiple="">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="subscribedShares">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="paidShares" name="paidShares"> 
