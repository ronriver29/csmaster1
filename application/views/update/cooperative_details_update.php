  ...
  <div class="col-sm-12 col-md-4">
    <div class="card border-top-blue shadow-sm mb-4">
      ...
      <div class="card-body">
        ...
        <p class="text-muted">
          <p class="text-muted">
          <?php if($coop_info->type_of_cooperative == 'Cooperative Bank' || $coop_info->type_of_cooperative == 'Insurance' || $coop_info->type_of_cooperative == 'Bank'){
            echo 'Others';
          } else {
  ...
  <div class="col-sm-12 col-md-8">
    <ul class="list-group">
      <li class="list-group-item  flex-column align-items-start">
        ...
        <?php if($coop_info->status!= 0): ?>
          <small class="text-muted">
            <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/bylaws_primary" class="btn btn-info btn-sm">View</a>
          </small>
        <?php endif;?>
      </li>
      ...
      <li class="list-group-item  flex-column align-items-start">
        ...
        <small class="text-muted">
           <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/cooperators_update" class="btn btn-info btn-sm">View</a>
        </small>
      <?php endif ?>
      </li>
      <li class="list-group-item  flex-column align-items-start">
        ...
        <li class="list-group-item  flex-column align-items-start">
          ...
          <li class="list-group-item  flex-column align-items-start">
            ...
            <?php // if(($coop_info->status == 1||$coop_info->status == 11) && $bylaw_complete && $purposes_complete && $article_complete && $grouping && $committees_complete && $economic_survey_complete && $staff_complete && $document_one && $document_two && $document_completed):
                if(($coop_info->status != 40 && strlen($coop_info->refbrgy_brgyCode)) == 9 && strlen($coop_info->type_of_cooperative) != 0 && $coop_info->status != 39):
            ?>
            <small class="text-muted">
