  ...
  <div class="col-sm-12 col-md-12">
    ...
    <!-- <div class="alert alert-info" role="alert"> -->
      <!-- <strong>Reminder:</strong> -->
       <!-- <ul>
        <?php $total_authorized_shares = isset($capitalization_info->authorized_share_capital) && isset($capitalization_info->par_value) ? isset($capitalization_info->authorized_share_capital)/isset($capitalization_info->par_value) : 0 ; ?>
           <li>Total Authorized Shared Capital: <?php echo "<strong>".$total_authorized_shares."</strong>";?> <?=isset($capitalization_info->authorized_share_capital) && isset($capitalization_info->par_value) ? "(".number_format(isset($capitalization_info->authorized_share_capital),0)." / ".isset($capitalization_info->par_value)." par value)" : ""?></li>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('cooperatives_update/'.$encrypted_id.'/article_update/primary',array('id'=>'articlesPrimaryForm','name'=>'articlesPrimaryForm')); ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-5">
            ...
            <label for="parValueCommon"><strong>What is the Par value per common share?</strong></label>
                        <input type="number" min="1" step="any" value="<?= isset($capitalization_info->par_value) ? $capitalization_info->par_value : ''?>" class="form-control" id="parValueCommon" name="parValueCommon" placeholder="&#8369;" disabled readonly="readonly">
           </div>
          </div>
          <?php if(isset($bylaw_info->kinds_of_members)==2): ?>
          <div class="col-sm-12 col-md-7">
          ...
          <div class="col-sm-12 col-md-5">
            ...
            <label for="parValuePreferred"><strong>What is the Par value per preferred share?</strong></label>
                        <input type="text" min="1" step="any" value="<?= isset($capitalization_info->par_value) ? $capitalization_info->par_value : ''?>" class="form-control" id="parValuePreferred" name="parValuePreferred" placeholder="&#8369;" disabled readonly="readonly">
           </div>
          </div>
        <?php endif ?>
        <div class="col-sm-12 col-md-12">
          ...
          <?php if(isset($capitalization_info->authorized_share_capital)){?>
            <input type="text" step="any" value="<?=$capitalization_info->authorized_share_capital ? number_format($capitalization_info->authorized_share_capital,2) : ''?>"  class="form-control"  id="authorizedShareCapital" name="authorizedShareCapital" placeholder="&#8369;" readonly>
          <?php } else {?>
            <input type="text" step="any" value=""  class="form-control"  id="authorizedShareCapital" name="authorizedShareCapital" placeholder="&#8369;" readonly>
          <?php } ?>
         </div>
        </div>
        </div>
