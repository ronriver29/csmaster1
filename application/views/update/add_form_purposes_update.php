<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/purposes_update" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('cooperatives_update/'.$encrypted_id.'/purposes_update/edit',array('id'=>'editPurposesForm','name'=>'editPurposesForm')); ?>
