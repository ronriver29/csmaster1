<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/staff_update" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    ...
    <?php echo form_open('cooperatives_update/'.$encrypted_id.'/staff_update/'.$encrypted_staff_id.'/edit',array('id'=>'editStaffForm','name'=>'editStaffForm')); ?>
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-5">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="fName" name="fName" value="<?= $staff_info->full_name?>">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              ...
              <select class="custom-select" name="statusOfAppointment">
                <option value="">--</option>
          ...
          <div class="w-100"></div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" style="resize: none;" id="pAddress" name="pAddress" rows="1"><?= $staff_info->postal_address?></textarea>
            </div>
      		</div>
          ...
          <div class="col-sm-12 col-md-3">
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="bDate" name="bDate" value="<?= $staff_info->birth_date?>">
            </div>
      		</div>
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              <label class="font-weight-bold"  for="subscribedShares">Minimum Education Experience/Training</label>
              <input type="textr" class="form-control" id="minimumEducation" name="minimumEducation" value="<?= $staff_info->minimum_education_experience_training?>">
            </div>
      		</div>
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              <label class="font-weight-bold" for="paidShares">Monthly Compensation</label>
              <input type="text" min="1" class="form-control" id="monthlyCompensation" name="monthlyCompensation" value="<?= number_format($staff_info->monthly_compensation,2)?>">
            </div>
      		</div>
        </div>
      </div>
