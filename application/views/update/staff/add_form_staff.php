...
<div class="row">
  <div class="col-sm-12 col-md-12">
    ...
    <?php echo form_open('cooperatives_update/'.$encrypted_id.'/staff_update/add',array('id'=>'addStaffForm','name'=>'addStaffForm')); ?>
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              ...
              <select class="custom-select" name="statusOfAppointment" id="statusOfAppointment">
                <option value="" selected>--</option>
          ...
          <div class="w-100"></div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" style="resize: none;" id="pAddress" name="pAddress" rows="1"></textarea>
            </div>
      		</div>
          ...
          <div class="col-sm-12 col-md-3">
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="bDate" name="bDate"> <!-- validate[funcCall[validateAgeCustom]] -->
            </div>
      		</div>
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              <label class="font-weight-bold"  for="minimumEducation">Minimum Education Experience/Training</label>
              <input type="textr" class="form-control" id="minimumEducation" name="minimumEducation">
            </div>
      		</div>
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              <label class="font-weight-bold" for="monthlyCompensation">Monthly Compensation</label>
              <input type="text" value="0" class="form-control validate[required,custom[number]]" id="monthlyCompensation" name="monthlyCompensation">
            </div>
      		</div>
        </div>
      </div>
