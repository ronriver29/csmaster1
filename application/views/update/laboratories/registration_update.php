<div class="row mb-2">
  <div class="col-sm-12 col-md-2">
    <a class="btn btn-secondary btn-sm btn-block"  href="<?php echo base_url();?>/laboratories_update/<?=$encrypted_id?>/view" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
  </div>
</div>
<div class="row">
  <div class="col">
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('laboratories_update/'.$encrypted_id.'/rupdate',array('id'=>'reserveUpdateFormLaboratories','name'=>'reserveUpdateFormLaboratories')); ?>
