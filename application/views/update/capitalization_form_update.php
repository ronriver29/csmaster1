...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('cooperatives_update/'.$encrypted_id.'/capitalization_update',array('id'=>'capitalizationForm','name'=>'capitalizationForm')); ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                            $tot_comon_share = '';
                            if(isset($total_regular['total_subscribed'])){
                            ...
                            if(isset($total_regular['total_paid'])){
                                $total_regular['total_paid'] = $total_regular['total_paid'];
                            } else {
                                $total_regular['total_paid'] = 0;
                            }
                            ?>
...
<?php $type_of_members = $kinds_of_members ==2 ? "associate" : "regular" ?>
