...
<div class="row">
  <div class="col-sm-12 col-md-12">
    ...
    <?php echo form_open('cooperatives_update/'.$encrypted_id.'/cooperators_update/'.$encrypted_cooperator_id.'/cooperators_update/edit',array('id'=>'editCooperatorForm','name'=>'editCooperatorForm')); ?>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-5">
            <div class="form-group">
              ...
              <input type="text" value="<?= $cooperator_info->full_name ?>" class="form-control validate[required,custom[fullname]]" id="fName" name="fName">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="form-group">
              ...
              <input type="number" value="<?= $cooperator_info->number_of_subscribed_shares ?>"  class="form-control validate[required,min[1],custom[integer]]" id="subscribedShares" name="subscribedShares">
          ...
          <div class="col-sm-12 col-md-3">
            <div class="form-group">
              ...
              <input type="number" value="<?= $cooperator_info->number_of_paid_up_shares ?>" class="form-control validate[required,min[1],custom[integer]]" id="paidShares" name="paidShares">
