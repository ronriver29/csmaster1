              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                  	<a class="btn btn-primary" target="_blank" href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/documents_update/view_document_one/<?= encrypt_custom($this->encryption->encrypt($row['filename']))?>/<?=$doc_types?>">View</a>
                    <?php $array_status = array(1,11); ?>
                    <?php if(($is_client && $coop_info->status!=40 && $coop_info->status!=40)): ?>
