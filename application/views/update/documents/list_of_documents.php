<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    ...
    <?php } else {?> 
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>cooperatives_update" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } } else {?>
      <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
    <?php } ?>
    <?php if(!$is_client) : ?>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php if(($is_client && $coop_info->status!=40 && $coop_info->status!=40) || (!$is_client && $coop_info->status==40)): ?>
            <?php // if($is_client ||) : ?>
                <!-- <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/documents_update/upload_document_one" class="btn btn-primary">Upload</a> -->
            <?php // endif;?>
          <?php endif; ?>
  ...
  <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          ...
          <?php if(($is_client && $coop_info->status!=40 && $coop_info->status!=40) || (!$is_client && $coop_info->status==40)): ?>
            <!-- <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/documents_update/upload_document_two" class="btn btn-primary">Upload</a> -->
          <?php endif; ?>
        </div>
      </div>
  </div>
  ...
  <div class="col-sm-12 col-md-4">
      <div class="card">
        <div class="card-body">
          ...
          <?php if(($is_client && $coop_info->status!=40 && $coop_info->status!=40) || (!$is_client && ($coop_info->status==40 || $coop_info->status==39))): ?>
            <?php // if($is_client) : ?>
            ...
            <div class="card-body">
              <h5 class="card-title"><?=$coop['coop_title']?></h5>
                ...
                <?php if($is_client && $coop_info->status<=1 || ($is_client && $coop_info->status==11)): ?>
                    <a href="<?php echo base_url();?>cooperatives_update/<?=$encrypted_id?>/documents_update/upload_document_others/<?=encrypt_custom($this->encryption->encrypt($coop['id']))?>" class="btn btn-primary">Upload</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
