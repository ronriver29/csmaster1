<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    ...
    <?php
        echo '<h5 class="text-primary text-right">Others</h5>';
    ?>
  </div>
</div>
<div class="row">
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open_multipart('documents_update/do_upload_others_unifed',array('id'=>'uploadOtherDocumentTwoForm','name'=>'uploadOtherDocumentTwoForm')); ?>
      <div class="card-body">
