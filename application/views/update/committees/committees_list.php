              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                    <a href="<?php echo base_url();?>cooperatives_update/<?= $encrypted_id ?>/committees_update/<?= encrypt_custom($this->encryption->encrypt($committee['comid'])) ?>/edit" class="btn btn-warning text-white"><i class="fas fa-edit"></i> Edit</a>
