...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      ...
      <?php echo form_open('unioncoop_update/update_cc',array('id'=>'addAdministratorForm','name'=>'addAdministratorForm')); ?>
      <div class="card-body">
        <div class="row">
...
<?php // } ?>
  <div class="col-sm-12 col-md-12">
    ...
    <div class="card">
      <div class="card-body">
        <?php echo form_open('cooperatives_update/'.$encrypted_id.'/unioncoop_update',array('id'=>'amendmentAddForm','name'=>'amendmentAddForm')); ?>
