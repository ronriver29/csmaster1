<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    <a class="btn btn-secondary btn-sm float-left"  href="<?php echo base_url();?>amendment_update/<?= $encrypted_id ?>/purposes" role="button"><i class="fas fa-arrow-left"></i> Go Back</a>
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open('amendment_update/'.$encrypted_id.'/amendment_purposes/edit',array('id'=>'editPurposesForm','name'=>'editPurposesForm')); ?>
              ...
              <div id="type_count<?=$key_counts++?>" >
                ...
                <div class="purposes_wrapper" >
                  <div class="form-group">
                    <a class="customDeleteBtn purposeRemoveBtn float-left text-danger"><i class="fas fa-minus-circle"></i></a>
