<div class="row mb-2">
  <div class="col-sm-12 col-md-12">
    ...
    <h5 class="text-primary text-right">Upload Other documents</h5>
  </div>
</div>
<div class="row">
  <div class="col-sm-12 col-md-12">
...
<div class="row">
  <div class="col-sm-12 col-md-12">
    <div class="card border-top-blue mb-4">
      <?php echo form_open_multipart('amendment_update_documents/do_upload_other',array('id'=>'uploadOtherDocumentForm','name'=>'uploadOtherDocumentForm')); ?>
      <div class="card-body">
        <div class="row ac-row">
          <input type="hidden" class="form-control" id="amendment_id" name="amendment_id" value="<?=$encrypted_id ?>">
         <!--  <input type="" class="form-control" id="status" name="status" value="<?=$coop_info->status?>"> -->
          <div class="col-sm-12 col-md-12">
