        ...
        <div class="card-body">
          <h5 class="card-title">Other Requirements</h5>
            <p class="card-text">
              ...
              {
              ?>
              <a target="_blank" href="<?php echo base_url();?>amendment_update_documents/list_upload_pdf/<?=$encrypted_id?>/30">
                <?php if($is_client) : ?>
              ...
              <?php if($is_client || $admin_info->access_level ==6):?>
                 <a href="<?php echo base_url();?>amendment_update/<?=$encrypted_id?>/amendment_update_documents/upload_document_other" class="btn btn-primary">Upload</a>
              <?php endif;?>
               </p>
        </div>
      </div>
