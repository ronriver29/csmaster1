      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <input type="text" value="<?= number_format($bylaw_info->membership_fee,2) ?>" min="0" step="any" class="form-control custom[number]]" id="membershipFee" name="membershipFee"   placeholder="&#8369; 0.00" disabled>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="form-group">
                      ...
                      <input type="number" value="<?=$bylaw_info->members_percent_quorom?>"  class="form-control validate[custom[integer]]" id="quorumPercentage" name="quorumPercentage"  placeholder="Enter Percent %" value="25" disabled>
               </div>
              </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="form-group">
                 ...
                 <input type="number" value="<?=$bylaw_info->number_of_absences_disqualification?>" class="form-control validate[custom[integer]]" id="consecutiveAbsences" name="consecutiveAbsences" min="2" placeholder="Enter Number" disabled>
              </div>
               <div class="form-group">
                 ...
                 <input type="number" value="<?=$bylaw_info->percent_of_absences_all_meettings?>" class="form-control validate[custom[integer]]" id="consecutivePercentageAbsences" name="consecutivePercentageAbsences"  placeholder="Enter Percent %" disabled>
              </div>
            </div>
          </div>
          <div class="row">
