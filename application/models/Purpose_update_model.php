...
class Purpose_update_model extends CI_Model{
  ...
  public function get_all_purposes($cooperatives_id,$type_of_cooperative){
    ...
    else
    {
       ...
       $temp_purpose = array(
        'cooperatives_id' => $cooperatives_id,
        'content'  => $this->get_purpose_content($type_of_cooperative,'Primary')
      );
       if($this->db->insert('purposes',$temp_purpose))
       {
         $query2 = $this->db->get_where('purposes',array('cooperatives_id'=>$cooperatives_id));
          $data = $query2->row();
       }
    }
    return $data;
