...
use Dompdf\Options;
class Documents_closure extends CI_Controller{
   var $pageCount = array();
        ...
        if(is_numeric($decoded_id) && $decoded_id!=0){
          if($this->session->userdata('client')){
            if($this->branches_model->check_own_branch($decoded_id,$user_id)){
                ...
                $this->load->view('template/header', $data);
                $this->load->view('documents/list_of_documents_branch_closure', $data);
                $this->load->view('template/footer');
...
//                if($this->branches_model->check_submitted_for_evaluation($decoded_id)) {
                  ...
                  // New
                  $data['branches_comments_cds'] = $this->branches_model->branches_comments_cds($branch_info->id);
                  $data['branches_comments_snr'] = $this->branches_model->branches_comments_snr_closure($branch_info->id,$evaluator_number);
                  ...
                  $data['branches_comments_level1_defer'] = $this->branches_model->branches_comments_closure_defer($branch_info->id);
                ...
                if($data['branch_info']->area_of_operation == 'Interregional'){
                  ...
                  $this->load->view('cooperative/evaluation/defer_modal_branch_closure');
                  $this->load->view('templates/admin_footer');
//                } else{
