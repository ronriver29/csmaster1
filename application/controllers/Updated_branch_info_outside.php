<?php
  ...
  class Updated_branch_info_outside extends CI_Controller{
            ...
            $this->benchmark->mark('code_start');
              ...
              // Head Office
                ...
                if($this->input->post('submit')) {
                  ...
                  'total_rows'=>$this->branch_update_model->get_all_updated_branch_info_count_outside($data['admin_info']->region_code,$coopname),
              ...
              // Head Office
                ...
                if($this->input->post('submit')) {
                  ...
                  $data['links']=$this->paginate($array);
                  $subcode = substr($data['admin_info']->region_code,1,2);
                  $data['list_branches'] = $this->branch_update_model->get_all_updated_Branch_info_outside($subcode,$coopname,$limit,$per_page);
