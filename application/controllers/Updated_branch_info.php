<?php
  ...
  class Updated_branch_info extends CI_Controller{
            ...
            $this->benchmark->mark('code_start');
              ...
              // Head Office
                ...
                if($this->input->post('submit')) {
                  ...
                  'total_rows'=>$this->branch_update_model->get_all_updated_branch_info_count($data['admin_info']->region_code,$coopname),
                  ...
                  $data['list_branches'] = $this->branch_update_model->get_all_updated_Branch_info2($data['admin_info']->region_code,$coopname,$limit,$per_page);
