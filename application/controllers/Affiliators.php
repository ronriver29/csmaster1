...
//                    $data['list_cooperators_count'] = $this->cooperator_model->get_all_cooperator_of_coop_regular_count($decoded_id);
                    ...
                    if(isset($_POST['btn-filter'])) {
                      ...
                      // } else {
                      // $data['registered_coop'] = $this->unioncoop_update_model->get_registered_fed_coop_update($data['coop_info']->area_of_operation,$data['coop_info']->refbrgy_brgyCode,$data['coop_info']->type_of_cooperative,$this->coopName,$this->regNo);
                      // }
