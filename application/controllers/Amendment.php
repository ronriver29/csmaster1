...
//                if($this->form_validation->run() == FALSE){
                if(!$this->input->post('Amendment_ID')){
                  ...
                  $coopTypeName= explode(',',$data['coop_info']->type_of_cooperative);
                  foreach($coopTypeName as $coop_typeName)
                  {
                     $list_of_major_industry_cooptype =$this->major_industry_model->get_major_industries_by_type_name($coop_typeName);
                       $list_type[] = $this->coop_type($coop_typeName);
                  $list_coop_type_id[] =$this->get_coopTypeID($coop_typeName); 
                  }
                 ...
                 if($data['coop_info']->common_bond_of_membership=='Occupational')
                 {
                  ...
                  $data['major_industry_list'] = $list_majors;
                  // $data['load_major'] = $list_majors;
                  $data['major_subclass_list'] = $list_subclass;
                 ...
                 // $this->debug($this->db->last_query());
                  ...
                  // $this->debug(rsort($data['business']));
                  $this->load->view('./template/header', $data);
