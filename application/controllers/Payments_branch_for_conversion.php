...
class Payments_branch_for_conversion extends CI_Controller{
...
//                      if($this->branches_model->check_evaluator5($decoded_id)){
                        ...
                        $this->load->view('cooperative/payment_form_branch_for_conversion', $data);
...
//            }                
  ...
  public function add_payment()
  {
    if ($this->input->post('offlineBtn')){
      ...
      $this->payment_branch_model->pay_offline_conversion($decoded_id);
      $data=array(
      ...
      set_time_limit(0);
         ...
         // $this->load->view('cooperative/order_of_payment_branch', $data1);
          $html2 = $this->load->view('cooperative/order_of_payment_branch_conversion', $data1, TRUE);
          $J = new pdf();
