...
class Staff_update extends CI_Controller{
                          ...
                          // if($data['gad_count']>0){
                            ...
                            // if($data['economic_survey_complete'] || $data['coop_info']->category_of_cooperative = 'Secondary' || $data['coop_info']->category_of_cooperative = 'Tertiary'){
                             ...
                             // var_dump($data['requirements_complete']);
                              ...
                              $this->load->view('update/staff/staff_list', $data);
                              $this->load->view('update/staff/delete_modal_staff');
                            ...
                            // if($data['economic_survey_complete'] || $data['coop_info']->category_of_cooperative = 'Secondary' || $data['coop_info']->category_of_cooperative = 'Tertiary'){
                              // if(!$this->cooperatives_model->check_submitted_for_evaluation($decoded_id)){
                                if(!isset($_POST['addStaffBtn'])){
                                  ...
                                  $this->load->view('./template/header', $data);
                                  $this->load->view('update/staff/add_form_staff', $data);
                                  $this->load->view('./template/footer');
                                }else{
                                  ...
                                  if($input_position == 'others')
                                  {
                                    ...
                                    'monthly_compensation' =>str_replace(',', '',$this->input->post('monthlyCompensation'))
                                      ...
                                      if($success['success']){ 
                                         ...
                                         redirect('cooperatives_update/'.$this->input->post('cooperativesID').'/staff_update');
                              ...
                              // if($this->staff_model->check_staff_in_cooperative($decoded_id,$decoded_staff_id)){ //check if staff is in cooperative
                                // if(!$this->cooperatives_model->check_submitted_for_evaluation($decoded_id)){
                                  ...
                                  else
                                  {
                                    ...
                                    $this->load->view('./template/header', $data);
                                    $this->load->view('update/staff/edit_form_staff', $data);
                                    $this->load->view('./template/footer');
                                  }else{
                ...
                if($this->staff_model->check_staff_in_cooperative($decoded_id,$decoded_post_staff_id)){
                  // if(!$this->cooperatives_model->check_submitted_for_evaluation($decoded_id)){
                    ...
                    if($success){
                      ...
                      redirect('cooperatives_update/'.$this->input->post('cooperativeID').'/staff_update');
                    }else{
