...
class Survey_update extends CI_Controller{
                    ...
                    // if($data['article_complete']){
                      ...
                      // if($data['gad_count']>0){
                        ...
                        if(!isset($_POST['economicSurveyBtn'])){
                          ...
                          if(isset($capital_init->total_amount_of_paid_up_capital)){
                          ...
                          $this->load->view('template/header', $data);
                           $this->load->view('update/economic_survey_info/economic_survey_form', $data);
                          ...
                          //end modify
                            ...
                            if($this->input->post('strategiesSupport')!=''){
                              $strategiesSupport_others = (in_array(4,$this->input->post('strategiesSupport')) ? $this->input->post('strategiesSupportOthersSpecify'): "");
                            } else {
                              $strategiesSupport_others = '';
                            }
                            ...
                            $data = array(
                              ...
                              'strategies_support_members_others'=> $strategiesSupport_others,
                              ...
                              'investments_others'=> $investments_others,
                              'equipments_etc'=> $equipments,
                              'equipments_etc_others'=> $equipments_etc_others,
                              'procure_equipments_etc'=> $procureEquipments,
                              'procure_equipments_etc_others'=> $procure_equipments_etc_others,
                            ...
                            // echo print_r($data);
                            // echo "<pre";
                            // var_dump($this->economic_survey_update_model->update_economic_survey($survey_coop_id,$data));
                            if($this->economic_survey_update_model->update_economic_survey($survey_coop_id,$data)){
                              $this->session->set_flashdata('survey_update_success', 'Successfully Updated');
                              redirect('cooperatives_update/'.$this->input->post('survey_coop_id').'/survey_update');
                            }else{
                          ...
                          if(!isset($_POST['economicSurveyBtn'])){
                            ...
                            $data = array(
                              ...
                              'education_programs_staff'=> $this->input->post('educationProgramStaff'),
                                ...
                                // echo print_r($this->economic_survey_model->update_economic_survey($survey_coop_id,$data));
                              if($this->economic_survey_update_model->update_economic_survey($survey_coop_id,$data)){
                                $this->session->set_flashdata('survey_update_success', 'Successfully Updated');
                                redirect('cooperatives_update/'.$this->input->post('survey_coop_id').'/survey_update');
                              }else{
