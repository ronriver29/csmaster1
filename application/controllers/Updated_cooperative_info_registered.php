<?php
  ...
  class Updated_cooperative_info_registered extends CI_Controller{
    ...
    public function index(){
      if(!$this->session->userdata('logged_in')){
        ...
        $data['is_client'] = $this->session->userdata('client');
            ...
            $this->benchmark->mark('code_start');
              ...
              // Head Office
                ...
                if($this->input->post('submit')) {
                  ...
                  $data['list_cooperatives_registered'] = $this->cooperatives_update_model->get_all_cooperatives_registration_ho($data['admin_info']->region_code,$coopname,$limit);
              ...
              // Head Office
                ...
                if($this->input->post('submit')) {
                  ...
                  $data['list_cooperatives_registered'] = $this->cooperatives_update_model->get_all_cooperatives_registration2($data['admin_info']->region_code,$coopname,$limit);
            ...
            $this->load->view('applications/list_of_updated_coop_info_registered', $data);
