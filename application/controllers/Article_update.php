...
class Article_update extends CI_Controller{
                ...
                // if($data['bylaw_complete']){
                  ...
                  // if($this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Primary" || $this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Secondary" || $this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Tertiary"){
                        if(!isset($_POST['articlesPrimaryBtn'])){
                          ...
                          $data['articles_info'] = $this->article_update_model->get_article_by_coop_id($decoded_id);
                          ...
                          $this->load->view('update/article/articles_primary_form_update', $data);
                          ...
                          // if(!$this->cooperatives_model->check_submitted_for_evaluation($decoded_id)){
                            ...
                            // var_dump($this->article_update_model->update_article_primary($article_coop_id,$data));
                            if($this->article_update_model->update_article_primary($article_coop_id,$data)){
                              $this->session->set_flashdata('article_success', 'Successfully Updated.');
                              redirect('cooperatives_update/'.$this->input->post('article_coop_id').'/article_update/primary');
                            }else{
                      ...
                      // }else{
                      //   redirect('cooperatives_update/'.$id.'/article_update');
                      // }
                    // }else{
                ...
                if($data['bylaw_complete']){
                  ...
                  if($this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Primary" || $this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Secondary" || $this->cooperatives_model->get_cooperative_info($user_id,$decoded_id)->category_of_cooperative =="Tertiary"){
                        if($this->form_validation->run() == FALSE){
                          ...
                          $data['total_associate'] = $this->cooperator_model->get_total_associate($decoded_id);
                          $this->load->view('template/header', $data);
                          $this->load->view('cooperative/articles_cooperation_info/articles_union_form.php', $data);
                          $this->load->view('template/footer');
                        }else{
                          if(!$this->cooperatives_model->check_submitted_for_evaluation($decoded_id)){
                            $article_coop_id = $this->encryption->decrypt(decrypt_custom($this->input->post('article_coop_id')));
                            ...
                            if($this->article_update_model->update_article_primary($article_coop_id,$data)){
                              $this->session->set_flashdata('article_success', 'Successfully Updated.');
                              redirect('cooperatives/'.$this->input->post('article_coop_id').'/articles_union');
                            }else{
                              $this->session->set_flashdata('article_error', 'Unable to update article of cooperation additional information.');
                              redirect('cooperatives/'.$this->input->post('article_coop_id').'/articles_union');
                            }
