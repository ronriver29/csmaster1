...
//      $('#deleteCooperatorForm #paidShares').val(minimum_paid_up_share_regular);
      ...
      $('#deleteCooperatorForm #subscribedShares').attr({'class':'form-control validate[required]'});
      $('#deleteCooperatorForm #paidShares').attr({'class':'form-control validate[required]'});
