$(function(){
  ...
  $('#addCooperatorFormAmendment #amd_paidShares').on('change', function(){
      ...
      //     $("#paid-note").show().html('Should not exceed the remaining no of paid up sharesdfsd: '+available_paid_up_capital);
      // }
  });
...
//      $('#addCooperatorFormAmendment #paidShares').val(minimum_paid_up_share_regular);
      ...
      $('#addCooperatorFormAmendment #amd_subscribedShares').attr({'class':'form-control'});
      $('#addCooperatorFormAmendment #amd_paidShares').attr({'class':'form-control'});
